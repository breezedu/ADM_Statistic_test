...
public class D1120_proportionOfDataset {
	
	/************
	 * 
	 * When passing shuffled local-ancestry datasets to the mixscore to do ADM analysis,
	 * The maximum values appeared in the first 1000 and the last 1000 SNPs,
	 * Thus, I wanna check the proportion of 1s, 2s, and 0s in the first and last 1000 lines,
	 * Also, I wanna compare the proportions between unshuffled data and shuffled datasets.
	 * 
	 * The results I got could be found in the explanations below: 
	 * 
	 * @param args
