 ...
 *  
 */
public class D1115_write_parameters_scripts {
	...
	public static void main(String[] args) throws IOException{
		...
		for(int i=0; i<1001; i++){
			...
			perl[3] = "ancfile:/work/AndrewGroup/ADM_test/ADM_Statistic_Data/transshuffled/" + i + "_transed_matrix.txt";
