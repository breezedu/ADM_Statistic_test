...
printf OUT "outfile:mixscore_shuffle366.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters366";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle366.out\n", $nsamples, $nsnps;
