...
printf OUT "outfile:mixscore_shuffle360.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters360";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle360.out\n", $nsamples, $nsnps;
