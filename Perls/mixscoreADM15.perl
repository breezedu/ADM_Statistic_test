...
printf OUT "outfile:mixscore_shuffle15.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters15";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle15.out\n", $nsamples, $nsnps;
