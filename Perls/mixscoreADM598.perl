...
printf OUT "outfile:mixscore_shuffle598.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters598";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle598.out\n", $nsamples, $nsnps;
