...
printf OUT "outfile:mixscore_shuffle290.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters290";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle290.out\n", $nsamples, $nsnps;
