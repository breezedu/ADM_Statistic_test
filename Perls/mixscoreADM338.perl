...
printf OUT "outfile:mixscore_shuffle338.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters338";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle338.out\n", $nsamples, $nsnps;
