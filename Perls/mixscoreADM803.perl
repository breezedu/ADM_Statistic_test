...
printf OUT "outfile:mixscore_shuffle803.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters803";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle803.out\n", $nsamples, $nsnps;
