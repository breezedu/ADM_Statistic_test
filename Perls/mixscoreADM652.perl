...
printf OUT "outfile:mixscore_shuffle652.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters652";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle652.out\n", $nsamples, $nsnps;
