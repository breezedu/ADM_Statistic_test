...
printf OUT "outfile:mixscore_shuffle751.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters751";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle751.out\n", $nsamples, $nsnps;
