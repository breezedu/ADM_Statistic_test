...
printf OUT "outfile:mixscore_shuffle418.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters418";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle418.out\n", $nsamples, $nsnps;
