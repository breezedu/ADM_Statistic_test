...
printf OUT "outfile:mixscore_shuffle482.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters482";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle482.out\n", $nsamples, $nsnps;
