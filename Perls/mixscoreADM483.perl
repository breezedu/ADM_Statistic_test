...
printf OUT "outfile:mixscore_shuffle483.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters483";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle483.out\n", $nsamples, $nsnps;
