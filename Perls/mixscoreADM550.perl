...
printf OUT "outfile:mixscore_shuffle550.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters550";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle550.out\n", $nsamples, $nsnps;
