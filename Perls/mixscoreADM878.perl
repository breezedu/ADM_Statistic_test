...
printf OUT "outfile:mixscore_shuffle878.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters878";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle878.out\n", $nsamples, $nsnps;
