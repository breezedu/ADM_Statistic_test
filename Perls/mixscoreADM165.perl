...
printf OUT "outfile:mixscore_shuffle165.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters165";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle165.out\n", $nsamples, $nsnps;
