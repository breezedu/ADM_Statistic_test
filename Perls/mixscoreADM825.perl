...
printf OUT "outfile:mixscore_shuffle825.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters825";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle825.out\n", $nsamples, $nsnps;
