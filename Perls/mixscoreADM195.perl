...
printf OUT "outfile:mixscore_shuffle195.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters195";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle195.out\n", $nsamples, $nsnps;
