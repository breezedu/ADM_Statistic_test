...
printf OUT "outfile:mixscore_shuffle77.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters77";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle77.out\n", $nsamples, $nsnps;
