...
printf OUT "outfile:mixscore_shuffle748.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters748";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle748.out\n", $nsamples, $nsnps;
