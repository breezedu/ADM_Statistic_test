...
printf OUT "outfile:mixscore_shuffle509.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters509";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle509.out\n", $nsamples, $nsnps;
