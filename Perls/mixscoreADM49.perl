...
printf OUT "outfile:mixscore_shuffle49.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters49";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle49.out\n", $nsamples, $nsnps;
