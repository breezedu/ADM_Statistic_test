...
printf OUT "outfile:mixscore_shuffle850.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters850";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle850.out\n", $nsamples, $nsnps;
