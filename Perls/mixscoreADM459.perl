...
printf OUT "outfile:mixscore_shuffle459.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters459";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle459.out\n", $nsamples, $nsnps;
