...
printf OUT "outfile:mixscore_shuffle868.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters868";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle868.out\n", $nsamples, $nsnps;
