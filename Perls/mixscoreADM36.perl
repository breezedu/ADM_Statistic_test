...
printf OUT "outfile:mixscore_shuffle36.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters36";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle36.out\n", $nsamples, $nsnps;
