...
printf OUT "outfile:mixscore_shuffle130.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters130";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle130.out\n", $nsamples, $nsnps;
