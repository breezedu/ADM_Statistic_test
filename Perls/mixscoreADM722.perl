...
printf OUT "outfile:mixscore_shuffle722.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters722";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle722.out\n", $nsamples, $nsnps;
