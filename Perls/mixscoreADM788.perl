...
printf OUT "outfile:mixscore_shuffle788.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters788";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle788.out\n", $nsamples, $nsnps;
