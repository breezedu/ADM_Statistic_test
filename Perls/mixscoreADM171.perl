...
printf OUT "outfile:mixscore_shuffle171.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters171";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle171.out\n", $nsamples, $nsnps;
