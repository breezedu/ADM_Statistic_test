...
printf OUT "outfile:mixscore_shuffle439.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters439";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle439.out\n", $nsamples, $nsnps;
