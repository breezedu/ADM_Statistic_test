...
printf OUT "outfile:mixscore_shuffle917.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters917";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle917.out\n", $nsamples, $nsnps;
