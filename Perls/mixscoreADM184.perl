...
printf OUT "outfile:mixscore_shuffle184.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters184";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle184.out\n", $nsamples, $nsnps;
