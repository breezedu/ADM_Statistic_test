...
printf OUT "outfile:mixscore_shuffle747.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters747";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle747.out\n", $nsamples, $nsnps;
