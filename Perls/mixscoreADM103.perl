...
printf OUT "outfile:mixscore_shuffle103.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters103";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle103.out\n", $nsamples, $nsnps;
