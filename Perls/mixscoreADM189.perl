...
printf OUT "outfile:mixscore_shuffle189.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters189";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle189.out\n", $nsamples, $nsnps;
