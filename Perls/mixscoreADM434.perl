...
printf OUT "outfile:mixscore_shuffle434.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters434";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle434.out\n", $nsamples, $nsnps;
