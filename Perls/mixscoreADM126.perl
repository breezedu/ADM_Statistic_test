...
printf OUT "outfile:mixscore_shuffle126.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters126";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle126.out\n", $nsamples, $nsnps;
