...
printf OUT "outfile:mixscore_shuffle945.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters945";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle945.out\n", $nsamples, $nsnps;
