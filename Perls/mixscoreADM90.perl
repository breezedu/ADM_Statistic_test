...
printf OUT "outfile:mixscore_shuffle90.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters90";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle90.out\n", $nsamples, $nsnps;
