...
printf OUT "outfile:mixscore_shuffle676.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters676";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle676.out\n", $nsamples, $nsnps;
