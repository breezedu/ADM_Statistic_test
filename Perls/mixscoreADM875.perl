...
printf OUT "outfile:mixscore_shuffle875.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters875";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle875.out\n", $nsamples, $nsnps;
