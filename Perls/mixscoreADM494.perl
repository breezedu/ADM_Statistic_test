...
printf OUT "outfile:mixscore_shuffle494.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters494";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle494.out\n", $nsamples, $nsnps;
