...
printf OUT "outfile:mixscore_shuffle902.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters902";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle902.out\n", $nsamples, $nsnps;
