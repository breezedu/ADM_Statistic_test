...
printf OUT "outfile:mixscore_shuffle632.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters632";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle632.out\n", $nsamples, $nsnps;
