...
printf OUT "outfile:mixscore_shuffle653.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters653";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle653.out\n", $nsamples, $nsnps;
