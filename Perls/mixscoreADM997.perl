...
printf OUT "outfile:mixscore_shuffle997.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters997";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle997.out\n", $nsamples, $nsnps;
