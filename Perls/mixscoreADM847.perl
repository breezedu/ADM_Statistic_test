...
printf OUT "outfile:mixscore_shuffle847.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters847";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle847.out\n", $nsamples, $nsnps;
