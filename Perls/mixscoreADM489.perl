...
printf OUT "outfile:mixscore_shuffle489.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters489";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle489.out\n", $nsamples, $nsnps;
