...
printf OUT "outfile:mixscore_shuffle161.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters161";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle161.out\n", $nsamples, $nsnps;
