...
printf OUT "outfile:mixscore_shuffle839.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters839";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle839.out\n", $nsamples, $nsnps;
