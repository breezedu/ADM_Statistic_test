...
printf OUT "outfile:mixscore_shuffle935.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters935";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle935.out\n", $nsamples, $nsnps;
