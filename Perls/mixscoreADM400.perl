...
printf OUT "outfile:mixscore_shuffle400.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters400";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle400.out\n", $nsamples, $nsnps;
