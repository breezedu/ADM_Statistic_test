...
printf OUT "outfile:mixscore_shuffle506.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters506";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle506.out\n", $nsamples, $nsnps;
