...
printf OUT "outfile:mixscore_shuffle298.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters298";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle298.out\n", $nsamples, $nsnps;
