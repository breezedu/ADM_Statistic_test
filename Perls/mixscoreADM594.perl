...
printf OUT "outfile:mixscore_shuffle594.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters594";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle594.out\n", $nsamples, $nsnps;
