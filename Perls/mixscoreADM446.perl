...
printf OUT "outfile:mixscore_shuffle446.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters446";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle446.out\n", $nsamples, $nsnps;
