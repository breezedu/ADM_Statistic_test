...
printf OUT "outfile:mixscore_shuffle599.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters599";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle599.out\n", $nsamples, $nsnps;
