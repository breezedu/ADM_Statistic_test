...
printf OUT "outfile:mixscore_shuffle470.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters470";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle470.out\n", $nsamples, $nsnps;
