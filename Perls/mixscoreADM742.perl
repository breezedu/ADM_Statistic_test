...
printf OUT "outfile:mixscore_shuffle742.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters742";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle742.out\n", $nsamples, $nsnps;
