...
printf OUT "outfile:mixscore_shuffle953.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters953";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle953.out\n", $nsamples, $nsnps;
