...
printf OUT "outfile:mixscore_shuffle144.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters144";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle144.out\n", $nsamples, $nsnps;
