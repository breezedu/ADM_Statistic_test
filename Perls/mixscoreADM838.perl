...
printf OUT "outfile:mixscore_shuffle838.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters838";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle838.out\n", $nsamples, $nsnps;
