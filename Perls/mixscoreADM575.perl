...
printf OUT "outfile:mixscore_shuffle575.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters575";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle575.out\n", $nsamples, $nsnps;
