...
printf OUT "outfile:mixscore_shuffle287.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters287";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle287.out\n", $nsamples, $nsnps;
