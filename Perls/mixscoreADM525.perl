...
printf OUT "outfile:mixscore_shuffle525.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters525";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle525.out\n", $nsamples, $nsnps;
