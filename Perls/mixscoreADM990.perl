...
printf OUT "outfile:mixscore_shuffle990.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters990";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle990.out\n", $nsamples, $nsnps;
