...
printf OUT "outfile:mixscore_shuffle670.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters670";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle670.out\n", $nsamples, $nsnps;
