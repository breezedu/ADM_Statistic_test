...
printf OUT "outfile:mixscore_shuffle246.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters246";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle246.out\n", $nsamples, $nsnps;
