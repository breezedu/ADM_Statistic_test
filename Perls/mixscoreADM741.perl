...
printf OUT "outfile:mixscore_shuffle741.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters741";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle741.out\n", $nsamples, $nsnps;
