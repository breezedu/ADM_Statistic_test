...
printf OUT "outfile:mixscore_shuffle801.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters801";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle801.out\n", $nsamples, $nsnps;
