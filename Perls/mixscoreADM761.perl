...
printf OUT "outfile:mixscore_shuffle761.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters761";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle761.out\n", $nsamples, $nsnps;
