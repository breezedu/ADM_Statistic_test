...
printf OUT "outfile:mixscore_shuffle174.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters174";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle174.out\n", $nsamples, $nsnps;
