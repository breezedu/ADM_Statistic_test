...
printf OUT "outfile:mixscore_shuffle485.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters485";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle485.out\n", $nsamples, $nsnps;
