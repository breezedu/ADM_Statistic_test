...
printf OUT "outfile:mixscore_shuffle590.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters590";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle590.out\n", $nsamples, $nsnps;
