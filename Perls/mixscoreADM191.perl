...
printf OUT "outfile:mixscore_shuffle191.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters191";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle191.out\n", $nsamples, $nsnps;
