...
printf OUT "outfile:mixscore_shuffle600.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters600";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle600.out\n", $nsamples, $nsnps;
