...
printf OUT "outfile:mixscore_shuffle293.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters293";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle293.out\n", $nsamples, $nsnps;
