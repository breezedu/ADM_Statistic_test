...
printf OUT "outfile:mixscore_shuffle909.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters909";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle909.out\n", $nsamples, $nsnps;
