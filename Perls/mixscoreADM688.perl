...
printf OUT "outfile:mixscore_shuffle688.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters688";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle688.out\n", $nsamples, $nsnps;
