...
printf OUT "outfile:mixscore_shuffle539.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters539";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle539.out\n", $nsamples, $nsnps;
