...
printf OUT "outfile:mixscore_shuffle163.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters163";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle163.out\n", $nsamples, $nsnps;
