...
printf OUT "outfile:mixscore_shuffle943.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters943";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle943.out\n", $nsamples, $nsnps;
