...
printf OUT "outfile:mixscore_shuffle270.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters270";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle270.out\n", $nsamples, $nsnps;
