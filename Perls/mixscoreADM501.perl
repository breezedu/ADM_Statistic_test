...
printf OUT "outfile:mixscore_shuffle501.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters501";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle501.out\n", $nsamples, $nsnps;
