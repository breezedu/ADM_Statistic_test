...
printf OUT "outfile:mixscore_shuffle309.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters309";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle309.out\n", $nsamples, $nsnps;
