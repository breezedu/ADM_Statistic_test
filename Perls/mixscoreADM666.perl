...
printf OUT "outfile:mixscore_shuffle666.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters666";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle666.out\n", $nsamples, $nsnps;
