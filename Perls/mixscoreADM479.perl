...
printf OUT "outfile:mixscore_shuffle479.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters479";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle479.out\n", $nsamples, $nsnps;
