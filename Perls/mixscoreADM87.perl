...
printf OUT "outfile:mixscore_shuffle87.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters87";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle87.out\n", $nsamples, $nsnps;
