...
printf OUT "outfile:mixscore_shuffle678.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters678";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle678.out\n", $nsamples, $nsnps;
