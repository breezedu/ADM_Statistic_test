...
printf OUT "outfile:mixscore_shuffle918.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters918";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle918.out\n", $nsamples, $nsnps;
