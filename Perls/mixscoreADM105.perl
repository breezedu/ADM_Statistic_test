...
printf OUT "outfile:mixscore_shuffle105.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters105";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle105.out\n", $nsamples, $nsnps;
