...
printf OUT "outfile:mixscore_shuffle219.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters219";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle219.out\n", $nsamples, $nsnps;
