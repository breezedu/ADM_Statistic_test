...
printf OUT "outfile:mixscore_shuffle638.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters638";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle638.out\n", $nsamples, $nsnps;
