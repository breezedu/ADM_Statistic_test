...
printf OUT "outfile:mixscore_shuffle13.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters13";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle13.out\n", $nsamples, $nsnps;
