...
printf OUT "outfile:mixscore_shuffle732.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters732";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle732.out\n", $nsamples, $nsnps;
