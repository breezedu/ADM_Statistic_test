...
printf OUT "outfile:mixscore_shuffle617.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters617";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle617.out\n", $nsamples, $nsnps;
