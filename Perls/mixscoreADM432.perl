...
printf OUT "outfile:mixscore_shuffle432.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters432";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle432.out\n", $nsamples, $nsnps;
