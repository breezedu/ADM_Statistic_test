...
printf OUT "outfile:mixscore_shuffle790.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters790";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle790.out\n", $nsamples, $nsnps;
