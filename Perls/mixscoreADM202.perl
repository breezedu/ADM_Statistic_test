...
printf OUT "outfile:mixscore_shuffle202.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters202";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle202.out\n", $nsamples, $nsnps;
