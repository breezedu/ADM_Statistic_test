...
printf OUT "outfile:mixscore_shuffle117.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters117";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle117.out\n", $nsamples, $nsnps;
