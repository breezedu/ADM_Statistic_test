...
printf OUT "outfile:mixscore_shuffle577.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters577";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle577.out\n", $nsamples, $nsnps;
