...
printf OUT "outfile:mixscore_shuffle221.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters221";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle221.out\n", $nsamples, $nsnps;
