...
printf OUT "outfile:mixscore_shuffle84.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters84";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle84.out\n", $nsamples, $nsnps;
