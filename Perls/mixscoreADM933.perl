...
printf OUT "outfile:mixscore_shuffle933.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters933";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle933.out\n", $nsamples, $nsnps;
