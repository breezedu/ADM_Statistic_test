...
printf OUT "outfile:mixscore_shuffle583.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters583";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle583.out\n", $nsamples, $nsnps;
