...
printf OUT "outfile:mixscore_shuffle125.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters125";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle125.out\n", $nsamples, $nsnps;
