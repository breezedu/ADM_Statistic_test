...
printf OUT "outfile:mixscore_shuffle733.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters733";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle733.out\n", $nsamples, $nsnps;
