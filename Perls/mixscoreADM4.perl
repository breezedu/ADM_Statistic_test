...
printf OUT "outfile:mixscore_shuffle4.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters4";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle4.out\n", $nsamples, $nsnps;
