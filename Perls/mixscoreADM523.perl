...
printf OUT "outfile:mixscore_shuffle523.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters523";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle523.out\n", $nsamples, $nsnps;
