...
printf OUT "outfile:mixscore_shuffle108.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters108";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle108.out\n", $nsamples, $nsnps;
