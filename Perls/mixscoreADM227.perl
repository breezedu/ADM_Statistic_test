...
printf OUT "outfile:mixscore_shuffle227.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters227";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle227.out\n", $nsamples, $nsnps;
