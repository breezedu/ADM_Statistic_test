...
printf OUT "outfile:mixscore_shuffle910.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters910";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle910.out\n", $nsamples, $nsnps;
