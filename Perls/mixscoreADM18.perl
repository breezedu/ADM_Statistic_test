...
printf OUT "outfile:mixscore_shuffle18.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters18";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle18.out\n", $nsamples, $nsnps;
