...
printf OUT "outfile:mixscore_shuffle925.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters925";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle925.out\n", $nsamples, $nsnps;
