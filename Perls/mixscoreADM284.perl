...
printf OUT "outfile:mixscore_shuffle284.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters284";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle284.out\n", $nsamples, $nsnps;
