...
printf OUT "outfile:mixscore_shuffle806.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters806";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle806.out\n", $nsamples, $nsnps;
