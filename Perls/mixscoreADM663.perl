...
printf OUT "outfile:mixscore_shuffle663.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters663";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle663.out\n", $nsamples, $nsnps;
