...
printf OUT "outfile:mixscore_shuffle542.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters542";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle542.out\n", $nsamples, $nsnps;
