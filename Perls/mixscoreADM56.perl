...
printf OUT "outfile:mixscore_shuffle56.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters56";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle56.out\n", $nsamples, $nsnps;
