...
printf OUT "outfile:mixscore_shuffle877.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters877";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle877.out\n", $nsamples, $nsnps;
