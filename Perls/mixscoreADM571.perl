...
printf OUT "outfile:mixscore_shuffle571.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters571";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle571.out\n", $nsamples, $nsnps;
