...
printf OUT "outfile:mixscore_shuffle179.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters179";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle179.out\n", $nsamples, $nsnps;
