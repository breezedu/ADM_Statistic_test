...
printf OUT "outfile:mixscore_shuffle94.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters94";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle94.out\n", $nsamples, $nsnps;
