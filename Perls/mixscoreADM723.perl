...
printf OUT "outfile:mixscore_shuffle723.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters723";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle723.out\n", $nsamples, $nsnps;
