...
printf OUT "outfile:mixscore_shuffle896.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters896";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle896.out\n", $nsamples, $nsnps;
