...
printf OUT "outfile:mixscore_shuffle975.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters975";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle975.out\n", $nsamples, $nsnps;
