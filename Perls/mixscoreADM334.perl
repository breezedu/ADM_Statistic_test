...
printf OUT "outfile:mixscore_shuffle334.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters334";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle334.out\n", $nsamples, $nsnps;
