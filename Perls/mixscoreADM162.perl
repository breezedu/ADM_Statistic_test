...
printf OUT "outfile:mixscore_shuffle162.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters162";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle162.out\n", $nsamples, $nsnps;
