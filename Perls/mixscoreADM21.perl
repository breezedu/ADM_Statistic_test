...
printf OUT "outfile:mixscore_shuffle21.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters21";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle21.out\n", $nsamples, $nsnps;
