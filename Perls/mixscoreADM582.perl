...
printf OUT "outfile:mixscore_shuffle582.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters582";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle582.out\n", $nsamples, $nsnps;
