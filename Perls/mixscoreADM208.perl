...
printf OUT "outfile:mixscore_shuffle208.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters208";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle208.out\n", $nsamples, $nsnps;
