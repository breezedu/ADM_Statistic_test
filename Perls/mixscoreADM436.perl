...
printf OUT "outfile:mixscore_shuffle436.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters436";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle436.out\n", $nsamples, $nsnps;
