...
printf OUT "outfile:mixscore_shuffle664.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters664";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle664.out\n", $nsamples, $nsnps;
