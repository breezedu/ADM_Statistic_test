...
printf OUT "outfile:mixscore_shuffle99.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters99";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle99.out\n", $nsamples, $nsnps;
