...
printf OUT "outfile:mixscore_shuffle876.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters876";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle876.out\n", $nsamples, $nsnps;
