...
printf OUT "outfile:mixscore_shuffle552.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters552";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle552.out\n", $nsamples, $nsnps;
