...
printf OUT "outfile:mixscore_shuffle568.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters568";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle568.out\n", $nsamples, $nsnps;
