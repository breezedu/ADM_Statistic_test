...
printf OUT "outfile:mixscore_shuffle857.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters857";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle857.out\n", $nsamples, $nsnps;
