...
printf OUT "outfile:mixscore_shuffle639.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters639";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle639.out\n", $nsamples, $nsnps;
