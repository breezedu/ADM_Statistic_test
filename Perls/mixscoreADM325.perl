...
printf OUT "outfile:mixscore_shuffle325.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters325";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle325.out\n", $nsamples, $nsnps;
