...
printf OUT "outfile:mixscore_shuffle62.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters62";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle62.out\n", $nsamples, $nsnps;
