...
printf OUT "outfile:mixscore_shuffle379.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters379";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle379.out\n", $nsamples, $nsnps;
