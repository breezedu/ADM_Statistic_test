...
printf OUT "outfile:mixscore_shuffle541.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters541";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle541.out\n", $nsamples, $nsnps;
