...
printf OUT "outfile:mixscore_shuffle11.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters11";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle11.out\n", $nsamples, $nsnps;
