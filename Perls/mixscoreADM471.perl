...
printf OUT "outfile:mixscore_shuffle471.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters471";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle471.out\n", $nsamples, $nsnps;
