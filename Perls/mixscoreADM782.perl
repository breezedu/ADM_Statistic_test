...
printf OUT "outfile:mixscore_shuffle782.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters782";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle782.out\n", $nsamples, $nsnps;
