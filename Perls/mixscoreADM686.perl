...
printf OUT "outfile:mixscore_shuffle686.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters686";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle686.out\n", $nsamples, $nsnps;
