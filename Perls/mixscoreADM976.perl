...
printf OUT "outfile:mixscore_shuffle976.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters976";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle976.out\n", $nsamples, $nsnps;
