...
printf OUT "outfile:mixscore_shuffle486.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters486";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle486.out\n", $nsamples, $nsnps;
