...
printf OUT "outfile:mixscore_shuffle921.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters921";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle921.out\n", $nsamples, $nsnps;
