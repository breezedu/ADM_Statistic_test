...
printf OUT "outfile:mixscore_shuffle710.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters710";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle710.out\n", $nsamples, $nsnps;
