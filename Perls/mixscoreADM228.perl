...
printf OUT "outfile:mixscore_shuffle228.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters228";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle228.out\n", $nsamples, $nsnps;
