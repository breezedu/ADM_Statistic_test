...
printf OUT "outfile:mixscore_shuffle30.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters30";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle30.out\n", $nsamples, $nsnps;
