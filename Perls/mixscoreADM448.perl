...
printf OUT "outfile:mixscore_shuffle448.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters448";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle448.out\n", $nsamples, $nsnps;
