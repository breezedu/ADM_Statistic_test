...
printf OUT "outfile:mixscore_shuffle524.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters524";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle524.out\n", $nsamples, $nsnps;
