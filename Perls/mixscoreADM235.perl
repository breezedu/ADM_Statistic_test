...
printf OUT "outfile:mixscore_shuffle235.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters235";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle235.out\n", $nsamples, $nsnps;
