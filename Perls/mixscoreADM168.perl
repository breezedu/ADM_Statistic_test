...
printf OUT "outfile:mixscore_shuffle168.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters168";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle168.out\n", $nsamples, $nsnps;
