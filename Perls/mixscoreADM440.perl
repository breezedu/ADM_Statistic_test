...
printf OUT "outfile:mixscore_shuffle440.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters440";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle440.out\n", $nsamples, $nsnps;
