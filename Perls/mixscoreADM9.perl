...
printf OUT "outfile:mixscore_shuffle9.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters9";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle9.out\n", $nsamples, $nsnps;
