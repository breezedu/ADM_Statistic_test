...
printf OUT "outfile:mixscore_shuffle745.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters745";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle745.out\n", $nsamples, $nsnps;
