...
printf OUT "outfile:mixscore_shuffle769.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters769";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle769.out\n", $nsamples, $nsnps;
