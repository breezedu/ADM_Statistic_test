...
printf OUT "outfile:mixscore_shuffle123.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters123";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle123.out\n", $nsamples, $nsnps;
