...
printf OUT "outfile:mixscore_shuffle267.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters267";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle267.out\n", $nsamples, $nsnps;
