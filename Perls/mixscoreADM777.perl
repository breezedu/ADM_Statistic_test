...
printf OUT "outfile:mixscore_shuffle777.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters777";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle777.out\n", $nsamples, $nsnps;
