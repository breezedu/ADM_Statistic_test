...
printf OUT "outfile:mixscore_shuffle913.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters913";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle913.out\n", $nsamples, $nsnps;
