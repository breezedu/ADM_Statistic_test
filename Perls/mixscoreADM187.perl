...
printf OUT "outfile:mixscore_shuffle187.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters187";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle187.out\n", $nsamples, $nsnps;
