...
printf OUT "outfile:mixscore_shuffle151.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters151";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle151.out\n", $nsamples, $nsnps;
