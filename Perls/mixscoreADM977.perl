...
printf OUT "outfile:mixscore_shuffle977.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters977";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle977.out\n", $nsamples, $nsnps;
