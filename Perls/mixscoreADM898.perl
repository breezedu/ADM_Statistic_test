...
printf OUT "outfile:mixscore_shuffle898.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters898";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle898.out\n", $nsamples, $nsnps;
