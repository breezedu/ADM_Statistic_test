...
printf OUT "outfile:mixscore_shuffle377.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters377";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle377.out\n", $nsamples, $nsnps;
