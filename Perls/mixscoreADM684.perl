...
printf OUT "outfile:mixscore_shuffle684.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters684";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle684.out\n", $nsamples, $nsnps;
