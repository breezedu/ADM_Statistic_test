...
printf OUT "outfile:mixscore_shuffle852.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters852";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle852.out\n", $nsamples, $nsnps;
