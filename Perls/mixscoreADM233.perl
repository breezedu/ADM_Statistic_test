...
printf OUT "outfile:mixscore_shuffle233.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters233";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle233.out\n", $nsamples, $nsnps;
