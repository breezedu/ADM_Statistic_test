...
printf OUT "outfile:mixscore_shuffle292.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters292";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle292.out\n", $nsamples, $nsnps;
