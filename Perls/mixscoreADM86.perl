...
printf OUT "outfile:mixscore_shuffle86.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters86";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle86.out\n", $nsamples, $nsnps;
