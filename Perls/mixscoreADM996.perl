...
printf OUT "outfile:mixscore_shuffle996.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters996";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle996.out\n", $nsamples, $nsnps;
