...
printf OUT "outfile:mixscore_shuffle503.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters503";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle503.out\n", $nsamples, $nsnps;
