...
printf OUT "outfile:mixscore_shuffle840.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters840";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle840.out\n", $nsamples, $nsnps;
