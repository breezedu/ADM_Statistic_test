...
printf OUT "outfile:mixscore_shuffle441.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters441";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle441.out\n", $nsamples, $nsnps;
