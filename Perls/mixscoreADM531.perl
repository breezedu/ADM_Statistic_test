...
printf OUT "outfile:mixscore_shuffle531.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters531";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle531.out\n", $nsamples, $nsnps;
