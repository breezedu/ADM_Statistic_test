...
printf OUT "outfile:mixscore_shuffle615.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters615";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle615.out\n", $nsamples, $nsnps;
