...
printf OUT "outfile:mixscore_shuffle73.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters73";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle73.out\n", $nsamples, $nsnps;
