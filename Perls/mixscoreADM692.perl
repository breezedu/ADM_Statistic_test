...
printf OUT "outfile:mixscore_shuffle692.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters692";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle692.out\n", $nsamples, $nsnps;
