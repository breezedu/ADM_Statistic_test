...
printf OUT "outfile:mixscore_shuffle48.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters48";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle48.out\n", $nsamples, $nsnps;
