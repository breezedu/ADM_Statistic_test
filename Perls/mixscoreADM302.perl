...
printf OUT "outfile:mixscore_shuffle302.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters302";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle302.out\n", $nsamples, $nsnps;
