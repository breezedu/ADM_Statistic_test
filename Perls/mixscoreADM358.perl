...
printf OUT "outfile:mixscore_shuffle358.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters358";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle358.out\n", $nsamples, $nsnps;
