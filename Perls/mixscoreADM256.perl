...
printf OUT "outfile:mixscore_shuffle256.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters256";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle256.out\n", $nsamples, $nsnps;
