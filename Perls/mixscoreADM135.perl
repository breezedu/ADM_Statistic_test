...
printf OUT "outfile:mixscore_shuffle135.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters135";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle135.out\n", $nsamples, $nsnps;
