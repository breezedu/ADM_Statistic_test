...
printf OUT "outfile:mixscore_shuffle351.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters351";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle351.out\n", $nsamples, $nsnps;
