...
printf OUT "outfile:mixscore_shuffle237.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters237";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle237.out\n", $nsamples, $nsnps;
