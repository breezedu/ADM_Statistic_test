...
printf OUT "outfile:mixscore_shuffle431.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters431";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle431.out\n", $nsamples, $nsnps;
