...
printf OUT "outfile:mixscore_shuffle182.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters182";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle182.out\n", $nsamples, $nsnps;
