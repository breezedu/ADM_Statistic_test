...
printf OUT "outfile:mixscore_shuffle802.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters802";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle802.out\n", $nsamples, $nsnps;
