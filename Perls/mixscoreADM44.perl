...
printf OUT "outfile:mixscore_shuffle44.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters44";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle44.out\n", $nsamples, $nsnps;
