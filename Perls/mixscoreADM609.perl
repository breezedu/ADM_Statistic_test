...
printf OUT "outfile:mixscore_shuffle609.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters609";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle609.out\n", $nsamples, $nsnps;
