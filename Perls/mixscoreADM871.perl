...
printf OUT "outfile:mixscore_shuffle871.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters871";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle871.out\n", $nsamples, $nsnps;
