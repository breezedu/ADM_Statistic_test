...
printf OUT "outfile:mixscore_shuffle879.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters879";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle879.out\n", $nsamples, $nsnps;
