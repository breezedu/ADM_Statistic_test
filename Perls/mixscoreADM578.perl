...
printf OUT "outfile:mixscore_shuffle578.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters578";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle578.out\n", $nsamples, $nsnps;
