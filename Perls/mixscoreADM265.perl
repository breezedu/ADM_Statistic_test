...
printf OUT "outfile:mixscore_shuffle265.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters265";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle265.out\n", $nsamples, $nsnps;
