...
printf OUT "outfile:mixscore_shuffle353.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters353";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle353.out\n", $nsamples, $nsnps;
