...
printf OUT "outfile:mixscore_shuffle651.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters651";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle651.out\n", $nsamples, $nsnps;
