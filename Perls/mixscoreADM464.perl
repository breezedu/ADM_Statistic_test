...
printf OUT "outfile:mixscore_shuffle464.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters464";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle464.out\n", $nsamples, $nsnps;
