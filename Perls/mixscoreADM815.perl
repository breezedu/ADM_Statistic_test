...
printf OUT "outfile:mixscore_shuffle815.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters815";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle815.out\n", $nsamples, $nsnps;
