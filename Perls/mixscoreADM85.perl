...
printf OUT "outfile:mixscore_shuffle85.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters85";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle85.out\n", $nsamples, $nsnps;
