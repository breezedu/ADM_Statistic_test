...
printf OUT "outfile:mixscore_shuffle786.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters786";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle786.out\n", $nsamples, $nsnps;
