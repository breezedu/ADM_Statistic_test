...
printf OUT "outfile:mixscore_shuffle895.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters895";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle895.out\n", $nsamples, $nsnps;
