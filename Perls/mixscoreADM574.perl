...
printf OUT "outfile:mixscore_shuffle574.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters574";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle574.out\n", $nsamples, $nsnps;
