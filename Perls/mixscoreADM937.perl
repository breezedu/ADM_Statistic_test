...
printf OUT "outfile:mixscore_shuffle937.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters937";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle937.out\n", $nsamples, $nsnps;
