...
printf OUT "outfile:mixscore_shuffle774.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters774";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle774.out\n", $nsamples, $nsnps;
