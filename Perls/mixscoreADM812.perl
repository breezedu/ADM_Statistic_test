...
printf OUT "outfile:mixscore_shuffle812.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters812";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle812.out\n", $nsamples, $nsnps;
