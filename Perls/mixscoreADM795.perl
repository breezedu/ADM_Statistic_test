...
printf OUT "outfile:mixscore_shuffle795.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters795";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle795.out\n", $nsamples, $nsnps;
