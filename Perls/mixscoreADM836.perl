...
printf OUT "outfile:mixscore_shuffle836.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters836";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle836.out\n", $nsamples, $nsnps;
