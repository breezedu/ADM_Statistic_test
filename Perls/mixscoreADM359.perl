...
printf OUT "outfile:mixscore_shuffle359.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters359";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle359.out\n", $nsamples, $nsnps;
