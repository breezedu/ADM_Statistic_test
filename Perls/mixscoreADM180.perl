...
printf OUT "outfile:mixscore_shuffle180.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters180";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle180.out\n", $nsamples, $nsnps;
