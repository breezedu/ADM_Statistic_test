...
printf OUT "outfile:mixscore_shuffle522.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters522";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle522.out\n", $nsamples, $nsnps;
