...
printf OUT "outfile:mixscore_shuffle277.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters277";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle277.out\n", $nsamples, $nsnps;
