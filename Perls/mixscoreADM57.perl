...
printf OUT "outfile:mixscore_shuffle57.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters57";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle57.out\n", $nsamples, $nsnps;
