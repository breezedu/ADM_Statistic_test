...
printf OUT "outfile:mixscore_shuffle892.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters892";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle892.out\n", $nsamples, $nsnps;
