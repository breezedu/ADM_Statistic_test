...
printf OUT "outfile:mixscore_shuffle79.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters79";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle79.out\n", $nsamples, $nsnps;
