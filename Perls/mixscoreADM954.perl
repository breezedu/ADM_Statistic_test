...
printf OUT "outfile:mixscore_shuffle954.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters954";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle954.out\n", $nsamples, $nsnps;
