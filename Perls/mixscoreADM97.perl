...
printf OUT "outfile:mixscore_shuffle97.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters97";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle97.out\n", $nsamples, $nsnps;
