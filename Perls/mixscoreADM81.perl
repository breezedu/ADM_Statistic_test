...
printf OUT "outfile:mixscore_shuffle81.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters81";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle81.out\n", $nsamples, $nsnps;
