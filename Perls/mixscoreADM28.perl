...
printf OUT "outfile:mixscore_shuffle28.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters28";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle28.out\n", $nsamples, $nsnps;
