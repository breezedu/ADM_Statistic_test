...
printf OUT "outfile:mixscore_shuffle558.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters558";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle558.out\n", $nsamples, $nsnps;
