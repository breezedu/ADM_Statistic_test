...
printf OUT "outfile:mixscore_shuffle720.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters720";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle720.out\n", $nsamples, $nsnps;
