...
printf OUT "outfile:mixscore_shuffle725.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters725";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle725.out\n", $nsamples, $nsnps;
