...
printf OUT "outfile:mixscore_shuffle826.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters826";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle826.out\n", $nsamples, $nsnps;
