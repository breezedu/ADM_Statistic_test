...
printf OUT "outfile:mixscore_shuffle158.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters158";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle158.out\n", $nsamples, $nsnps;
