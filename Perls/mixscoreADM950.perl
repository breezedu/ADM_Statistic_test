...
printf OUT "outfile:mixscore_shuffle950.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters950";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle950.out\n", $nsamples, $nsnps;
