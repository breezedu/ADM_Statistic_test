...
printf OUT "outfile:mixscore_shuffle67.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters67";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle67.out\n", $nsamples, $nsnps;
