...
printf OUT "outfile:mixscore_shuffle561.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters561";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle561.out\n", $nsamples, $nsnps;
