...
printf OUT "outfile:mixscore_shuffle386.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters386";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle386.out\n", $nsamples, $nsnps;
