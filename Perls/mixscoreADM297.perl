...
printf OUT "outfile:mixscore_shuffle297.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters297";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle297.out\n", $nsamples, $nsnps;
