...
printf OUT "outfile:mixscore_shuffle96.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters96";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle96.out\n", $nsamples, $nsnps;
