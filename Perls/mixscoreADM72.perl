...
printf OUT "outfile:mixscore_shuffle72.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters72";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle72.out\n", $nsamples, $nsnps;
