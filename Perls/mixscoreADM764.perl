...
printf OUT "outfile:mixscore_shuffle764.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters764";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle764.out\n", $nsamples, $nsnps;
