...
printf OUT "outfile:mixscore_shuffle118.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters118";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle118.out\n", $nsamples, $nsnps;
