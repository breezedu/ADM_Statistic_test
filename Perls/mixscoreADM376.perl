...
printf OUT "outfile:mixscore_shuffle376.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters376";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle376.out\n", $nsamples, $nsnps;
