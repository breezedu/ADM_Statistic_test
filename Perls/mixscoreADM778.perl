...
printf OUT "outfile:mixscore_shuffle778.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters778";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle778.out\n", $nsamples, $nsnps;
