...
printf OUT "outfile:mixscore_shuffle372.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters372";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle372.out\n", $nsamples, $nsnps;
