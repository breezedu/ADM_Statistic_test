...
printf OUT "outfile:mixscore_shuffle425.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters425";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle425.out\n", $nsamples, $nsnps;
