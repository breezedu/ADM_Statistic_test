...
printf OUT "outfile:mixscore_shuffle614.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters614";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle614.out\n", $nsamples, $nsnps;
