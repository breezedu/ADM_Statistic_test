...
printf OUT "outfile:mixscore_shuffle799.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters799";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle799.out\n", $nsamples, $nsnps;
