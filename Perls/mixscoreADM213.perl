...
printf OUT "outfile:mixscore_shuffle213.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters213";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle213.out\n", $nsamples, $nsnps;
