...
printf OUT "outfile:mixscore_shuffle363.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters363";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle363.out\n", $nsamples, $nsnps;
