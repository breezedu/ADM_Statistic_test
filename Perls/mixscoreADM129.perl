...
printf OUT "outfile:mixscore_shuffle129.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters129";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle129.out\n", $nsamples, $nsnps;
