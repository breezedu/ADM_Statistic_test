...
printf OUT "outfile:mixscore_shuffle60.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters60";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle60.out\n", $nsamples, $nsnps;
