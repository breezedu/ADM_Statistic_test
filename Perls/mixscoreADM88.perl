...
printf OUT "outfile:mixscore_shuffle88.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters88";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle88.out\n", $nsamples, $nsnps;
