...
printf OUT "outfile:mixscore_shuffle603.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters603";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle603.out\n", $nsamples, $nsnps;
