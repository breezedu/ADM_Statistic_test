...
printf OUT "outfile:mixscore_shuffle991.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters991";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle991.out\n", $nsamples, $nsnps;
