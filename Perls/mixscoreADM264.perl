...
printf OUT "outfile:mixscore_shuffle264.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters264";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle264.out\n", $nsamples, $nsnps;
