...
printf OUT "outfile:mixscore_shuffle657.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters657";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle657.out\n", $nsamples, $nsnps;
