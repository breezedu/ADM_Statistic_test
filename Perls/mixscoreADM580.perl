...
printf OUT "outfile:mixscore_shuffle580.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters580";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle580.out\n", $nsamples, $nsnps;
