...
printf OUT "outfile:mixscore_shuffle901.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters901";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle901.out\n", $nsamples, $nsnps;
