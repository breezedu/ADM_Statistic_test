...
printf OUT "outfile:mixscore_shuffle141.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters141";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle141.out\n", $nsamples, $nsnps;
