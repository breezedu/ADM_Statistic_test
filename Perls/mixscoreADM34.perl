...
printf OUT "outfile:mixscore_shuffle34.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters34";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle34.out\n", $nsamples, $nsnps;
