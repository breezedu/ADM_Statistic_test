...
printf OUT "outfile:mixscore_shuffle962.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters962";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle962.out\n", $nsamples, $nsnps;
