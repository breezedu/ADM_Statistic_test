...
printf OUT "outfile:mixscore_shuffle499.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters499";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle499.out\n", $nsamples, $nsnps;
