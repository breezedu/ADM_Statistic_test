...
printf OUT "outfile:mixscore_shuffle52.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters52";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle52.out\n", $nsamples, $nsnps;
