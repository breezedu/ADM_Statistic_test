...
printf OUT "outfile:mixscore_shuffle771.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters771";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle771.out\n", $nsamples, $nsnps;
