...
printf OUT "outfile:mixscore_shuffle709.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters709";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle709.out\n", $nsamples, $nsnps;
