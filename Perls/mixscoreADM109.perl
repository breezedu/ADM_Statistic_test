...
printf OUT "outfile:mixscore_shuffle109.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters109";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle109.out\n", $nsamples, $nsnps;
