...
printf OUT "outfile:mixscore_shuffle119.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters119";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle119.out\n", $nsamples, $nsnps;
