...
printf OUT "outfile:mixscore_shuffle417.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters417";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle417.out\n", $nsamples, $nsnps;
