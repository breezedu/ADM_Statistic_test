...
printf OUT "outfile:mixscore_shuffle759.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters759";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle759.out\n", $nsamples, $nsnps;
