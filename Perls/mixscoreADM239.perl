...
printf OUT "outfile:mixscore_shuffle239.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters239";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle239.out\n", $nsamples, $nsnps;
