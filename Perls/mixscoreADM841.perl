...
printf OUT "outfile:mixscore_shuffle841.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters841";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle841.out\n", $nsamples, $nsnps;
