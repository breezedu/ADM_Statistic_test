...
printf OUT "outfile:mixscore_shuffle186.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters186";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle186.out\n", $nsamples, $nsnps;
