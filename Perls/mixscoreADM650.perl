...
printf OUT "outfile:mixscore_shuffle650.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters650";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle650.out\n", $nsamples, $nsnps;
