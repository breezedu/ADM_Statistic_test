...
printf OUT "outfile:mixscore_shuffle930.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters930";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle930.out\n", $nsamples, $nsnps;
