...
printf OUT "outfile:mixscore_shuffle210.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters210";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle210.out\n", $nsamples, $nsnps;
