...
printf OUT "outfile:mixscore_shuffle588.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters588";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle588.out\n", $nsamples, $nsnps;
