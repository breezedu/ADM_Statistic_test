...
printf OUT "outfile:mixscore_shuffle791.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters791";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle791.out\n", $nsamples, $nsnps;
