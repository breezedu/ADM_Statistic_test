...
printf OUT "outfile:mixscore_shuffle998.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters998";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle998.out\n", $nsamples, $nsnps;
