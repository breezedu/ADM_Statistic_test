...
printf OUT "outfile:mixscore_shuffle54.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters54";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle54.out\n", $nsamples, $nsnps;
