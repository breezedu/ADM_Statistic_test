...
printf OUT "outfile:mixscore_shuffle861.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters861";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle861.out\n", $nsamples, $nsnps;
