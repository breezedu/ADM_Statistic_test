...
printf OUT "outfile:mixscore_shuffle181.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters181";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle181.out\n", $nsamples, $nsnps;
