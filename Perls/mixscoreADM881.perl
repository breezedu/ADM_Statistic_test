...
printf OUT "outfile:mixscore_shuffle881.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters881";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle881.out\n", $nsamples, $nsnps;
