...
printf OUT "outfile:mixscore_shuffle66.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters66";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle66.out\n", $nsamples, $nsnps;
