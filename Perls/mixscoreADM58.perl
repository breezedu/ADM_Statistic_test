...
printf OUT "outfile:mixscore_shuffle58.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters58";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle58.out\n", $nsamples, $nsnps;
