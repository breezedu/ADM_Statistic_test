...
printf OUT "outfile:mixscore_shuffle556.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters556";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle556.out\n", $nsamples, $nsnps;
