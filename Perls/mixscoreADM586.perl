...
printf OUT "outfile:mixscore_shuffle586.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters586";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle586.out\n", $nsamples, $nsnps;
