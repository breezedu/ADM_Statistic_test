...
printf OUT "outfile:mixscore_shuffle207.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters207";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle207.out\n", $nsamples, $nsnps;
