...
printf OUT "outfile:mixscore_shuffle445.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters445";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle445.out\n", $nsamples, $nsnps;
