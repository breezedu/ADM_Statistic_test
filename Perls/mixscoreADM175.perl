...
printf OUT "outfile:mixscore_shuffle175.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters175";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle175.out\n", $nsamples, $nsnps;
