...
printf OUT "outfile:mixscore_shuffle973.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters973";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle973.out\n", $nsamples, $nsnps;
