...
printf OUT "outfile:mixscore_shuffle547.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters547";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle547.out\n", $nsamples, $nsnps;
