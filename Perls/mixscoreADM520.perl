...
printf OUT "outfile:mixscore_shuffle520.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters520";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle520.out\n", $nsamples, $nsnps;
