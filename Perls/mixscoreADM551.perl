...
printf OUT "outfile:mixscore_shuffle551.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters551";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle551.out\n", $nsamples, $nsnps;
