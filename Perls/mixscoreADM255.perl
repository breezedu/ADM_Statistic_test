...
printf OUT "outfile:mixscore_shuffle255.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters255";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle255.out\n", $nsamples, $nsnps;
