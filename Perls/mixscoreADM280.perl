...
printf OUT "outfile:mixscore_shuffle280.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters280";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle280.out\n", $nsamples, $nsnps;
