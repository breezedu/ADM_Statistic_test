...
printf OUT "outfile:mixscore_shuffle537.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters537";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle537.out\n", $nsamples, $nsnps;
