...
printf OUT "outfile:mixscore_shuffle234.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters234";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle234.out\n", $nsamples, $nsnps;
