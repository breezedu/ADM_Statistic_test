...
printf OUT "outfile:mixscore_shuffle660.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters660";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle660.out\n", $nsamples, $nsnps;
