...
printf OUT "outfile:mixscore_shuffle932.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters932";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle932.out\n", $nsamples, $nsnps;
