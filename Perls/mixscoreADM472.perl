...
printf OUT "outfile:mixscore_shuffle472.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters472";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle472.out\n", $nsamples, $nsnps;
