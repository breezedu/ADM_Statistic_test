...
printf OUT "outfile:mixscore_shuffle661.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters661";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle661.out\n", $nsamples, $nsnps;
