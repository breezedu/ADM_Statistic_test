...
printf OUT "outfile:mixscore_shuffle294.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters294";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle294.out\n", $nsamples, $nsnps;
