...
printf OUT "outfile:mixscore_shuffle83.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters83";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle83.out\n", $nsamples, $nsnps;
