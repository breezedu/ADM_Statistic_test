...
printf OUT "outfile:mixscore_shuffle47.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters47";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle47.out\n", $nsamples, $nsnps;
