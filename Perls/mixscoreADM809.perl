...
printf OUT "outfile:mixscore_shuffle809.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters809";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle809.out\n", $nsamples, $nsnps;
