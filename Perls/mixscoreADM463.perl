...
printf OUT "outfile:mixscore_shuffle463.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters463";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle463.out\n", $nsamples, $nsnps;
