...
printf OUT "outfile:mixscore_shuffle25.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters25";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle25.out\n", $nsamples, $nsnps;
