...
printf OUT "outfile:mixscore_shuffle31.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters31";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle31.out\n", $nsamples, $nsnps;
