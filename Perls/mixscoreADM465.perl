...
printf OUT "outfile:mixscore_shuffle465.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters465";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle465.out\n", $nsamples, $nsnps;
