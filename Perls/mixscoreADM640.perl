...
printf OUT "outfile:mixscore_shuffle640.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters640";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle640.out\n", $nsamples, $nsnps;
