...
printf OUT "outfile:mixscore_shuffle697.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters697";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle697.out\n", $nsamples, $nsnps;
