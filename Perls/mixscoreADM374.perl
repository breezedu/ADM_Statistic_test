...
printf OUT "outfile:mixscore_shuffle374.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters374";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle374.out\n", $nsamples, $nsnps;
