...
printf OUT "outfile:mixscore_shuffle987.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters987";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle987.out\n", $nsamples, $nsnps;
