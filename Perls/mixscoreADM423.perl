...
printf OUT "outfile:mixscore_shuffle423.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters423";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle423.out\n", $nsamples, $nsnps;
