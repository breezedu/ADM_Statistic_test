...
printf OUT "outfile:mixscore_shuffle923.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters923";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle923.out\n", $nsamples, $nsnps;
