...
printf OUT "outfile:mixscore_shuffle383.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters383";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle383.out\n", $nsamples, $nsnps;
