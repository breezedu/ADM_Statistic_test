...
printf OUT "outfile:mixscore_shuffle530.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters530";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle530.out\n", $nsamples, $nsnps;
