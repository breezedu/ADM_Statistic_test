...
printf OUT "outfile:mixscore_shuffle848.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters848";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle848.out\n", $nsamples, $nsnps;
