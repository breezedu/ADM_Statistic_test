...
printf OUT "outfile:mixscore_shuffle702.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters702";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle702.out\n", $nsamples, $nsnps;
