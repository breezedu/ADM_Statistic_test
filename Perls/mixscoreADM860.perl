...
printf OUT "outfile:mixscore_shuffle860.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters860";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle860.out\n", $nsamples, $nsnps;
