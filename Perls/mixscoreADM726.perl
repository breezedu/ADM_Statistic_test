...
printf OUT "outfile:mixscore_shuffle726.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters726";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle726.out\n", $nsamples, $nsnps;
