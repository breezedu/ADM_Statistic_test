...
printf OUT "outfile:mixscore_shuffle137.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters137";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle137.out\n", $nsamples, $nsnps;
