...
printf OUT "outfile:mixscore_shuffle389.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters389";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle389.out\n", $nsamples, $nsnps;
