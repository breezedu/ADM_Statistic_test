...
printf OUT "outfile:mixscore_shuffle665.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters665";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle665.out\n", $nsamples, $nsnps;
