...
printf OUT "outfile:mixscore_shuffle922.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters922";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle922.out\n", $nsamples, $nsnps;
