...
printf OUT "outfile:mixscore_shuffle740.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters740";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle740.out\n", $nsamples, $nsnps;
