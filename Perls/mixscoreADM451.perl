...
printf OUT "outfile:mixscore_shuffle451.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters451";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle451.out\n", $nsamples, $nsnps;
