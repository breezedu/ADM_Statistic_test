...
printf OUT "outfile:mixscore_shuffle938.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters938";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle938.out\n", $nsamples, $nsnps;
