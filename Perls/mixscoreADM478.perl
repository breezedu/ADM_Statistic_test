...
printf OUT "outfile:mixscore_shuffle478.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters478";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle478.out\n", $nsamples, $nsnps;
