...
printf OUT "outfile:mixscore_shuffle200.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters200";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle200.out\n", $nsamples, $nsnps;
