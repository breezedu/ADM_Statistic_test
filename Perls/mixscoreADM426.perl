...
printf OUT "outfile:mixscore_shuffle426.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters426";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle426.out\n", $nsamples, $nsnps;
