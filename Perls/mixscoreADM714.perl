...
printf OUT "outfile:mixscore_shuffle714.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters714";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle714.out\n", $nsamples, $nsnps;
