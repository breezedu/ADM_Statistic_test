...
printf OUT "outfile:mixscore_shuffle569.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters569";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle569.out\n", $nsamples, $nsnps;
