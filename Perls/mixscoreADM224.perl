...
printf OUT "outfile:mixscore_shuffle224.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters224";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle224.out\n", $nsamples, $nsnps;
