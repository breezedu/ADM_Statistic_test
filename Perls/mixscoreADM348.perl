...
printf OUT "outfile:mixscore_shuffle348.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters348";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle348.out\n", $nsamples, $nsnps;
