...
printf OUT "outfile:mixscore_shuffle703.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters703";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle703.out\n", $nsamples, $nsnps;
