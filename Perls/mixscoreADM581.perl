...
printf OUT "outfile:mixscore_shuffle581.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters581";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle581.out\n", $nsamples, $nsnps;
