...
printf OUT "outfile:mixscore_shuffle553.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters553";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle553.out\n", $nsamples, $nsnps;
