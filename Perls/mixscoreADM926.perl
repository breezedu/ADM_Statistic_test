...
printf OUT "outfile:mixscore_shuffle926.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters926";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle926.out\n", $nsamples, $nsnps;
