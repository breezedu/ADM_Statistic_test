...
printf OUT "outfile:mixscore_shuffle375.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters375";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle375.out\n", $nsamples, $nsnps;
