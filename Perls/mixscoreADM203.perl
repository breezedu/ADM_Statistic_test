...
printf OUT "outfile:mixscore_shuffle203.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters203";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle203.out\n", $nsamples, $nsnps;
