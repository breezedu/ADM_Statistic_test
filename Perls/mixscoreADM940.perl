...
printf OUT "outfile:mixscore_shuffle940.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters940";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle940.out\n", $nsamples, $nsnps;
