...
printf OUT "outfile:mixscore_shuffle222.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters222";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle222.out\n", $nsamples, $nsnps;
