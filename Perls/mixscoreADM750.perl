...
printf OUT "outfile:mixscore_shuffle750.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters750";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle750.out\n", $nsamples, $nsnps;
