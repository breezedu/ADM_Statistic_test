...
printf OUT "outfile:mixscore_shuffle251.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters251";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle251.out\n", $nsamples, $nsnps;
