...
printf OUT "outfile:mixscore_shuffle983.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters983";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle983.out\n", $nsamples, $nsnps;
