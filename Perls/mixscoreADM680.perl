...
printf OUT "outfile:mixscore_shuffle680.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters680";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle680.out\n", $nsamples, $nsnps;
