...
printf OUT "outfile:mixscore_shuffle315.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters315";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle315.out\n", $nsamples, $nsnps;
