...
printf OUT "outfile:mixscore_shuffle63.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters63";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle63.out\n", $nsamples, $nsnps;
