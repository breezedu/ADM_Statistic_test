...
printf OUT "outfile:mixscore_shuffle538.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters538";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle538.out\n", $nsamples, $nsnps;
