...
printf OUT "outfile:mixscore_shuffle527.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters527";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle527.out\n", $nsamples, $nsnps;
