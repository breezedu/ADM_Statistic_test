...
printf OUT "outfile:mixscore_shuffle429.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters429";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle429.out\n", $nsamples, $nsnps;
