...
printf OUT "outfile:mixscore_shuffle303.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters303";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle303.out\n", $nsamples, $nsnps;
