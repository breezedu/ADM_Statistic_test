...
printf OUT "outfile:mixscore_shuffle779.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters779";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle779.out\n", $nsamples, $nsnps;
