...
printf OUT "outfile:mixscore_shuffle585.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters585";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle585.out\n", $nsamples, $nsnps;
