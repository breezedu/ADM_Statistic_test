...
printf OUT "outfile:mixscore_shuffle188.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters188";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle188.out\n", $nsamples, $nsnps;
