...
printf OUT "outfile:mixscore_shuffle821.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters821";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle821.out\n", $nsamples, $nsnps;
