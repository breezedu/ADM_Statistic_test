...
printf OUT "outfile:mixscore_shuffle851.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters851";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle851.out\n", $nsamples, $nsnps;
