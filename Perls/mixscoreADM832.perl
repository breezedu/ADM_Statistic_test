...
printf OUT "outfile:mixscore_shuffle832.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters832";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle832.out\n", $nsamples, $nsnps;
