...
printf OUT "outfile:mixscore_shuffle517.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters517";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle517.out\n", $nsamples, $nsnps;
