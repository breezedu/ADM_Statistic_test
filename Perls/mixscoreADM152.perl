...
printf OUT "outfile:mixscore_shuffle152.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters152";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle152.out\n", $nsamples, $nsnps;
