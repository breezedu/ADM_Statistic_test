...
printf OUT "outfile:mixscore_shuffle674.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters674";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle674.out\n", $nsamples, $nsnps;
