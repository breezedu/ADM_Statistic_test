...
printf OUT "outfile:mixscore_shuffle319.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters319";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle319.out\n", $nsamples, $nsnps;
