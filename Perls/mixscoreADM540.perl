...
printf OUT "outfile:mixscore_shuffle540.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters540";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle540.out\n", $nsamples, $nsnps;
