...
printf OUT "outfile:mixscore_shuffle549.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters549";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle549.out\n", $nsamples, $nsnps;
