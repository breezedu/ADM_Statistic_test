...
printf OUT "outfile:mixscore_shuffle278.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters278";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle278.out\n", $nsamples, $nsnps;
