...
printf OUT "outfile:mixscore_shuffle707.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters707";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle707.out\n", $nsamples, $nsnps;
