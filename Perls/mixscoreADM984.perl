...
printf OUT "outfile:mixscore_shuffle984.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters984";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle984.out\n", $nsamples, $nsnps;
