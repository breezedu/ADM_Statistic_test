...
printf OUT "outfile:mixscore_shuffle261.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters261";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle261.out\n", $nsamples, $nsnps;
