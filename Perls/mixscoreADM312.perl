...
printf OUT "outfile:mixscore_shuffle312.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters312";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle312.out\n", $nsamples, $nsnps;
