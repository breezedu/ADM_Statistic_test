...
printf OUT "outfile:mixscore_shuffle276.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters276";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle276.out\n", $nsamples, $nsnps;
