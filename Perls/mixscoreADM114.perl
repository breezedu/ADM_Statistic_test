...
printf OUT "outfile:mixscore_shuffle114.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters114";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle114.out\n", $nsamples, $nsnps;
