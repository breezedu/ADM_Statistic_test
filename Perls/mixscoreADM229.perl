...
printf OUT "outfile:mixscore_shuffle229.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters229";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle229.out\n", $nsamples, $nsnps;
