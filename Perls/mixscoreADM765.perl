...
printf OUT "outfile:mixscore_shuffle765.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters765";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle765.out\n", $nsamples, $nsnps;
