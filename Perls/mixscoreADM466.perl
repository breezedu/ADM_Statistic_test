...
printf OUT "outfile:mixscore_shuffle466.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters466";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle466.out\n", $nsamples, $nsnps;
