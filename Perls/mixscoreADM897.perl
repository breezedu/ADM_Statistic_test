...
printf OUT "outfile:mixscore_shuffle897.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters897";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle897.out\n", $nsamples, $nsnps;
