...
printf OUT "outfile:mixscore_shuffle155.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters155";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle155.out\n", $nsamples, $nsnps;
