...
printf OUT "outfile:mixscore_shuffle164.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters164";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle164.out\n", $nsamples, $nsnps;
