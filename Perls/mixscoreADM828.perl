...
printf OUT "outfile:mixscore_shuffle828.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters828";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle828.out\n", $nsamples, $nsnps;
