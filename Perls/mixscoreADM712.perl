...
printf OUT "outfile:mixscore_shuffle712.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters712";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle712.out\n", $nsamples, $nsnps;
