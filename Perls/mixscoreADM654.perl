...
printf OUT "outfile:mixscore_shuffle654.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters654";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle654.out\n", $nsamples, $nsnps;
