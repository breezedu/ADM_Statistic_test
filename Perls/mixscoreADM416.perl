...
printf OUT "outfile:mixscore_shuffle416.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters416";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle416.out\n", $nsamples, $nsnps;
