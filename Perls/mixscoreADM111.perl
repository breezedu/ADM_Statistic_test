...
printf OUT "outfile:mixscore_shuffle111.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters111";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle111.out\n", $nsamples, $nsnps;
