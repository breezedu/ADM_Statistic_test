...
printf OUT "outfile:mixscore_shuffle562.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters562";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle562.out\n", $nsamples, $nsnps;
