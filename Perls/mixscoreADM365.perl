...
printf OUT "outfile:mixscore_shuffle365.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters365";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle365.out\n", $nsamples, $nsnps;
