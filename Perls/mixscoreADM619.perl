...
printf OUT "outfile:mixscore_shuffle619.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters619";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle619.out\n", $nsamples, $nsnps;
