...
printf OUT "outfile:mixscore_shuffle150.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters150";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle150.out\n", $nsamples, $nsnps;
