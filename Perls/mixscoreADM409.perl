...
printf OUT "outfile:mixscore_shuffle409.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters409";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle409.out\n", $nsamples, $nsnps;
