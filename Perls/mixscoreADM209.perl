...
printf OUT "outfile:mixscore_shuffle209.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters209";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle209.out\n", $nsamples, $nsnps;
