...
printf OUT "outfile:mixscore_shuffle842.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters842";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle842.out\n", $nsamples, $nsnps;
