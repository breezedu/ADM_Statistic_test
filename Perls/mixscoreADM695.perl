...
printf OUT "outfile:mixscore_shuffle695.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters695";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle695.out\n", $nsamples, $nsnps;
