...
printf OUT "outfile:mixscore_shuffle893.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters893";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle893.out\n", $nsamples, $nsnps;
