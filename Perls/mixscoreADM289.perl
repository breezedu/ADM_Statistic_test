...
printf OUT "outfile:mixscore_shuffle289.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters289";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle289.out\n", $nsamples, $nsnps;
