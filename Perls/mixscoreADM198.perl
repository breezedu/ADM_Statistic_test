...
printf OUT "outfile:mixscore_shuffle198.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters198";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle198.out\n", $nsamples, $nsnps;
