...
printf OUT "outfile:mixscore_shuffle833.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters833";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle833.out\n", $nsamples, $nsnps;
