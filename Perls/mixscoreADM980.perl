...
printf OUT "outfile:mixscore_shuffle980.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters980";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle980.out\n", $nsamples, $nsnps;
