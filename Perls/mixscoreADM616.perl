...
printf OUT "outfile:mixscore_shuffle616.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters616";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle616.out\n", $nsamples, $nsnps;
