...
printf OUT "outfile:mixscore_shuffle116.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters116";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle116.out\n", $nsamples, $nsnps;
