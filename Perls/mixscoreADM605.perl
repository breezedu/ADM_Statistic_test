...
printf OUT "outfile:mixscore_shuffle605.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters605";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle605.out\n", $nsamples, $nsnps;
