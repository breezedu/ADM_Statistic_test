...
printf OUT "outfile:mixscore_shuffle915.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters915";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle915.out\n", $nsamples, $nsnps;
