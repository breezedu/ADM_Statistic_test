...
printf OUT "outfile:mixscore_shuffle232.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters232";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle232.out\n", $nsamples, $nsnps;
