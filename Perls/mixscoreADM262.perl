...
printf OUT "outfile:mixscore_shuffle262.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters262";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle262.out\n", $nsamples, $nsnps;
