...
printf OUT "outfile:mixscore_shuffle743.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters743";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle743.out\n", $nsamples, $nsnps;
