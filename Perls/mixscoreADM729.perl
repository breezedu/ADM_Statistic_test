...
printf OUT "outfile:mixscore_shuffle729.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters729";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle729.out\n", $nsamples, $nsnps;
