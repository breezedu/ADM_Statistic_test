...
printf OUT "outfile:mixscore_shuffle804.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters804";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle804.out\n", $nsamples, $nsnps;
