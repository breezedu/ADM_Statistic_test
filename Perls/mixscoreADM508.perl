...
printf OUT "outfile:mixscore_shuffle508.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters508";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle508.out\n", $nsamples, $nsnps;
