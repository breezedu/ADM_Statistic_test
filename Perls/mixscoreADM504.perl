...
printf OUT "outfile:mixscore_shuffle504.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters504";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle504.out\n", $nsamples, $nsnps;
