...
printf OUT "outfile:mixscore_shuffle473.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters473";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle473.out\n", $nsamples, $nsnps;
