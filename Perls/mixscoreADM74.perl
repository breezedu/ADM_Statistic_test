...
printf OUT "outfile:mixscore_shuffle74.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters74";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle74.out\n", $nsamples, $nsnps;
