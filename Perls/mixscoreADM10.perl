...
printf OUT "outfile:mixscore_shuffle10.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters10";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle10.out\n", $nsamples, $nsnps;
