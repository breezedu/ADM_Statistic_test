...
printf OUT "outfile:mixscore_shuffle645.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters645";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle645.out\n", $nsamples, $nsnps;
