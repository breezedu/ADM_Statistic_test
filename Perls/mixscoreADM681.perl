...
printf OUT "outfile:mixscore_shuffle681.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters681";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle681.out\n", $nsamples, $nsnps;
