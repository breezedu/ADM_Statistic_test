...
printf OUT "outfile:mixscore_shuffle27.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters27";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle27.out\n", $nsamples, $nsnps;
