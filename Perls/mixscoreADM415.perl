...
printf OUT "outfile:mixscore_shuffle415.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters415";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle415.out\n", $nsamples, $nsnps;
