...
printf OUT "outfile:mixscore_shuffle827.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters827";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle827.out\n", $nsamples, $nsnps;
