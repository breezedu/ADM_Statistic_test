...
printf OUT "outfile:mixscore_shuffle621.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters621";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle621.out\n", $nsamples, $nsnps;
