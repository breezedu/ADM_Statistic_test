...
printf OUT "outfile:mixscore_shuffle773.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters773";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle773.out\n", $nsamples, $nsnps;
