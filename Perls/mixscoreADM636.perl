...
printf OUT "outfile:mixscore_shuffle636.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters636";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle636.out\n", $nsamples, $nsnps;
