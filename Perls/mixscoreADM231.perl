...
printf OUT "outfile:mixscore_shuffle231.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters231";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle231.out\n", $nsamples, $nsnps;
