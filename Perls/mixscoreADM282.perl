...
printf OUT "outfile:mixscore_shuffle282.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters282";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle282.out\n", $nsamples, $nsnps;
