...
printf OUT "outfile:mixscore_shuffle258.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters258";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle258.out\n", $nsamples, $nsnps;
