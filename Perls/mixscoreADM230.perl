...
printf OUT "outfile:mixscore_shuffle230.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters230";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle230.out\n", $nsamples, $nsnps;
