...
printf OUT "outfile:mixscore_shuffle406.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters406";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle406.out\n", $nsamples, $nsnps;
