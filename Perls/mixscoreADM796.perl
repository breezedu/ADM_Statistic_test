...
printf OUT "outfile:mixscore_shuffle796.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters796";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle796.out\n", $nsamples, $nsnps;
