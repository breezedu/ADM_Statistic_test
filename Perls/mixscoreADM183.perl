...
printf OUT "outfile:mixscore_shuffle183.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters183";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle183.out\n", $nsamples, $nsnps;
