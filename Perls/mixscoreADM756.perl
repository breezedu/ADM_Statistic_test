...
printf OUT "outfile:mixscore_shuffle756.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters756";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle756.out\n", $nsamples, $nsnps;
