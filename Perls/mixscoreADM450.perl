...
printf OUT "outfile:mixscore_shuffle450.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters450";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle450.out\n", $nsamples, $nsnps;
