...
printf OUT "outfile:mixscore_shuffle642.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters642";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle642.out\n", $nsamples, $nsnps;
