...
printf OUT "outfile:mixscore_shuffle797.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters797";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle797.out\n", $nsamples, $nsnps;
