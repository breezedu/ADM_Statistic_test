...
printf OUT "outfile:mixscore_shuffle286.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters286";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle286.out\n", $nsamples, $nsnps;
