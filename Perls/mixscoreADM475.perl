...
printf OUT "outfile:mixscore_shuffle475.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters475";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle475.out\n", $nsamples, $nsnps;
