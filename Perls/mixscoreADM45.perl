...
printf OUT "outfile:mixscore_shuffle45.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters45";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle45.out\n", $nsamples, $nsnps;
