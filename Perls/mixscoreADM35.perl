...
printf OUT "outfile:mixscore_shuffle35.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters35";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle35.out\n", $nsamples, $nsnps;
