...
printf OUT "outfile:mixscore_shuffle385.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters385";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle385.out\n", $nsamples, $nsnps;
