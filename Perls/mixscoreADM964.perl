...
printf OUT "outfile:mixscore_shuffle964.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters964";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle964.out\n", $nsamples, $nsnps;
