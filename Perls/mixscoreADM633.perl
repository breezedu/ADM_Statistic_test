...
printf OUT "outfile:mixscore_shuffle633.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters633";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle633.out\n", $nsamples, $nsnps;
