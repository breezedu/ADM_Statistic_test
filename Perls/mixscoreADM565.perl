...
printf OUT "outfile:mixscore_shuffle565.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters565";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle565.out\n", $nsamples, $nsnps;
