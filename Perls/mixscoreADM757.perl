...
printf OUT "outfile:mixscore_shuffle757.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters757";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle757.out\n", $nsamples, $nsnps;
