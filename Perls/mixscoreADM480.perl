...
printf OUT "outfile:mixscore_shuffle480.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters480";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle480.out\n", $nsamples, $nsnps;
