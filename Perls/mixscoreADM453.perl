...
printf OUT "outfile:mixscore_shuffle453.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters453";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle453.out\n", $nsamples, $nsnps;
