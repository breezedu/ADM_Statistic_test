...
printf OUT "outfile:mixscore_shuffle424.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters424";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle424.out\n", $nsamples, $nsnps;
