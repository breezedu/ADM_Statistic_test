...
printf OUT "outfile:mixscore_shuffle699.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters699";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle699.out\n", $nsamples, $nsnps;
