...
printf OUT "outfile:mixscore_shuffle356.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters356";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle356.out\n", $nsamples, $nsnps;
