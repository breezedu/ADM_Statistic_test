...
printf OUT "outfile:mixscore_shuffle285.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters285";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle285.out\n", $nsamples, $nsnps;
