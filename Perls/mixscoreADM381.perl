...
printf OUT "outfile:mixscore_shuffle381.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters381";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle381.out\n", $nsamples, $nsnps;
