...
printf OUT "outfile:mixscore_shuffle591.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters591";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle591.out\n", $nsamples, $nsnps;
