...
printf OUT "outfile:mixscore_shuffle190.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters190";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle190.out\n", $nsamples, $nsnps;
