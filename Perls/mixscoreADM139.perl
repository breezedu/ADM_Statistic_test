...
printf OUT "outfile:mixscore_shuffle139.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters139";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle139.out\n", $nsamples, $nsnps;
