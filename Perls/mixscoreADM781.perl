...
printf OUT "outfile:mixscore_shuffle781.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters781";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle781.out\n", $nsamples, $nsnps;
