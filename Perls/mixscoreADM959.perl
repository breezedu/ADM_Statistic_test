...
printf OUT "outfile:mixscore_shuffle959.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters959";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle959.out\n", $nsamples, $nsnps;
