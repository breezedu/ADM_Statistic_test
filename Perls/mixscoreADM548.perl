...
printf OUT "outfile:mixscore_shuffle548.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters548";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle548.out\n", $nsamples, $nsnps;
