...
printf OUT "outfile:mixscore_shuffle626.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters626";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle626.out\n", $nsamples, $nsnps;
