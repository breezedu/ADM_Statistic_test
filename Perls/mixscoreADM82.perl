...
printf OUT "outfile:mixscore_shuffle82.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters82";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle82.out\n", $nsamples, $nsnps;
