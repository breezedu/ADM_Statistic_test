...
printf OUT "outfile:mixscore_shuffle127.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters127";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle127.out\n", $nsamples, $nsnps;
