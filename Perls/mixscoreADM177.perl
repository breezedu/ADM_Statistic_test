...
printf OUT "outfile:mixscore_shuffle177.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters177";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle177.out\n", $nsamples, $nsnps;
