...
printf OUT "outfile:mixscore_shuffle557.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters557";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle557.out\n", $nsamples, $nsnps;
