...
printf OUT "outfile:mixscore_shuffle247.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters247";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle247.out\n", $nsamples, $nsnps;
