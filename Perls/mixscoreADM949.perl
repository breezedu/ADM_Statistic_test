...
printf OUT "outfile:mixscore_shuffle949.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters949";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle949.out\n", $nsamples, $nsnps;
