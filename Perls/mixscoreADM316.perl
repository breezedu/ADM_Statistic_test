...
printf OUT "outfile:mixscore_shuffle316.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters316";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle316.out\n", $nsamples, $nsnps;
