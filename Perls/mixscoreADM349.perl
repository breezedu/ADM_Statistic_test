...
printf OUT "outfile:mixscore_shuffle349.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters349";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle349.out\n", $nsamples, $nsnps;
