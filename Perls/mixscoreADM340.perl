...
printf OUT "outfile:mixscore_shuffle340.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters340";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle340.out\n", $nsamples, $nsnps;
