...
printf OUT "outfile:mixscore_shuffle407.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters407";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle407.out\n", $nsamples, $nsnps;
