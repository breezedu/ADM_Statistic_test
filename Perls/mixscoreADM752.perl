...
printf OUT "outfile:mixscore_shuffle752.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters752";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle752.out\n", $nsamples, $nsnps;
