...
printf OUT "outfile:mixscore_shuffle3.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters3";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle3.out\n", $nsamples, $nsnps;
