...
printf OUT "outfile:mixscore_shuffle393.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters393";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle393.out\n", $nsamples, $nsnps;
