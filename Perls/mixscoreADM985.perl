...
printf OUT "outfile:mixscore_shuffle985.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters985";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle985.out\n", $nsamples, $nsnps;
