...
printf OUT "outfile:mixscore_shuffle427.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters427";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle427.out\n", $nsamples, $nsnps;
