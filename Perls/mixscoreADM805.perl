...
printf OUT "outfile:mixscore_shuffle805.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters805";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle805.out\n", $nsamples, $nsnps;
