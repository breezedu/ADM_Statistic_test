...
printf OUT "outfile:mixscore_shuffle920.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters920";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle920.out\n", $nsamples, $nsnps;
