...
printf OUT "outfile:mixscore_shuffle576.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters576";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle576.out\n", $nsamples, $nsnps;
