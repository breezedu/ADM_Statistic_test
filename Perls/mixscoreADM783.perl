...
printf OUT "outfile:mixscore_shuffle783.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters783";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle783.out\n", $nsamples, $nsnps;
