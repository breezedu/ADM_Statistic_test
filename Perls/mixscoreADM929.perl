...
printf OUT "outfile:mixscore_shuffle929.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters929";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle929.out\n", $nsamples, $nsnps;
