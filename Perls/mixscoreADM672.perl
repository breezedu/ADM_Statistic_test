...
printf OUT "outfile:mixscore_shuffle672.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters672";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle672.out\n", $nsamples, $nsnps;
