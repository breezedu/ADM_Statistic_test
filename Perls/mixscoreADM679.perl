...
printf OUT "outfile:mixscore_shuffle679.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters679";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle679.out\n", $nsamples, $nsnps;
