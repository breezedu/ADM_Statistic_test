...
printf OUT "outfile:mixscore_shuffle75.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters75";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle75.out\n", $nsamples, $nsnps;
