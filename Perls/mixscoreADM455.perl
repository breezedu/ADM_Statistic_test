...
printf OUT "outfile:mixscore_shuffle455.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters455";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle455.out\n", $nsamples, $nsnps;
