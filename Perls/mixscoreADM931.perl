...
printf OUT "outfile:mixscore_shuffle931.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters931";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle931.out\n", $nsamples, $nsnps;
