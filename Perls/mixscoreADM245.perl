...
printf OUT "outfile:mixscore_shuffle245.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters245";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle245.out\n", $nsamples, $nsnps;
