...
printf OUT "outfile:mixscore_shuffle98.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters98";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle98.out\n", $nsamples, $nsnps;
