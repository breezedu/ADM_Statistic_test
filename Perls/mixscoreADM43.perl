...
printf OUT "outfile:mixscore_shuffle43.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters43";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle43.out\n", $nsamples, $nsnps;
