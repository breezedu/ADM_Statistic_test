...
printf OUT "outfile:mixscore_shuffle965.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters965";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle965.out\n", $nsamples, $nsnps;
