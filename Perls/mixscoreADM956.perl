...
printf OUT "outfile:mixscore_shuffle956.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters956";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle956.out\n", $nsamples, $nsnps;
