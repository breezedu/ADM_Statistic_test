...
printf OUT "outfile:mixscore_shuffle817.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters817";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle817.out\n", $nsamples, $nsnps;
