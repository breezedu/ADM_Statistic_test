...
printf OUT "outfile:mixscore_shuffle546.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters546";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle546.out\n", $nsamples, $nsnps;
