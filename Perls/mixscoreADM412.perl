...
printf OUT "outfile:mixscore_shuffle412.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters412";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle412.out\n", $nsamples, $nsnps;
