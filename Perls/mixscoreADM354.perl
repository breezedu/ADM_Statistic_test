...
printf OUT "outfile:mixscore_shuffle354.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters354";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle354.out\n", $nsamples, $nsnps;
