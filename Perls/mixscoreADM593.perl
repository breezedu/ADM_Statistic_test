...
printf OUT "outfile:mixscore_shuffle593.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters593";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle593.out\n", $nsamples, $nsnps;
