...
printf OUT "outfile:mixscore_shuffle91.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters91";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle91.out\n", $nsamples, $nsnps;
