...
printf OUT "outfile:mixscore_shuffle618.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters618";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle618.out\n", $nsamples, $nsnps;
