...
printf OUT "outfile:mixscore_shuffle64.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters64";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle64.out\n", $nsamples, $nsnps;
