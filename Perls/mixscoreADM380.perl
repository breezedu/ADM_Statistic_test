...
printf OUT "outfile:mixscore_shuffle380.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters380";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle380.out\n", $nsamples, $nsnps;
