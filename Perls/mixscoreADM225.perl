...
printf OUT "outfile:mixscore_shuffle225.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters225";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle225.out\n", $nsamples, $nsnps;
