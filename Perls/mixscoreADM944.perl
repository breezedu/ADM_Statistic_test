...
printf OUT "outfile:mixscore_shuffle944.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters944";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle944.out\n", $nsamples, $nsnps;
