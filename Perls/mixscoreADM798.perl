...
printf OUT "outfile:mixscore_shuffle798.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters798";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle798.out\n", $nsamples, $nsnps;
