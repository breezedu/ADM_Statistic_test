...
printf OUT "outfile:mixscore_shuffle199.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters199";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle199.out\n", $nsamples, $nsnps;
