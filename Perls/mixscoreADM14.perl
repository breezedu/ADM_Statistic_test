...
printf OUT "outfile:mixscore_shuffle14.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters14";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle14.out\n", $nsamples, $nsnps;
