...
printf OUT "outfile:mixscore_shuffle487.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters487";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle487.out\n", $nsamples, $nsnps;
