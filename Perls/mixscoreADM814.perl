...
printf OUT "outfile:mixscore_shuffle814.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters814";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle814.out\n", $nsamples, $nsnps;
