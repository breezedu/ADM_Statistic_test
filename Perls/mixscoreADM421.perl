...
printf OUT "outfile:mixscore_shuffle421.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters421";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle421.out\n", $nsamples, $nsnps;
