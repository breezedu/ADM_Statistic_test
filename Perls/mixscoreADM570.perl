...
printf OUT "outfile:mixscore_shuffle570.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters570";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle570.out\n", $nsamples, $nsnps;
