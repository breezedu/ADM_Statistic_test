...
printf OUT "outfile:mixscore_shuffle69.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters69";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle69.out\n", $nsamples, $nsnps;
