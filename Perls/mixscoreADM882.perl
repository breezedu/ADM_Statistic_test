...
printf OUT "outfile:mixscore_shuffle882.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters882";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle882.out\n", $nsamples, $nsnps;
