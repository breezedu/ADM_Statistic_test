...
printf OUT "outfile:mixscore_shuffle327.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters327";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle327.out\n", $nsamples, $nsnps;
