...
printf OUT "outfile:mixscore_shuffle205.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters205";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle205.out\n", $nsamples, $nsnps;
