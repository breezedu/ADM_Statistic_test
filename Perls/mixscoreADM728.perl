...
printf OUT "outfile:mixscore_shuffle728.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters728";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle728.out\n", $nsamples, $nsnps;
