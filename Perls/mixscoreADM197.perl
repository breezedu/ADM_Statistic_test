...
printf OUT "outfile:mixscore_shuffle197.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters197";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle197.out\n", $nsamples, $nsnps;
