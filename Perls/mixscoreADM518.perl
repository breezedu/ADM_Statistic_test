...
printf OUT "outfile:mixscore_shuffle518.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters518";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle518.out\n", $nsamples, $nsnps;
