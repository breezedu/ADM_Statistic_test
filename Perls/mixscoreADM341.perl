...
printf OUT "outfile:mixscore_shuffle341.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters341";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle341.out\n", $nsamples, $nsnps;
