...
printf OUT "outfile:mixscore_shuffle631.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters631";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle631.out\n", $nsamples, $nsnps;
