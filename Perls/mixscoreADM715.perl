...
printf OUT "outfile:mixscore_shuffle715.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters715";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle715.out\n", $nsamples, $nsnps;
