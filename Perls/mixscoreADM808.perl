...
printf OUT "outfile:mixscore_shuffle808.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters808";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle808.out\n", $nsamples, $nsnps;
