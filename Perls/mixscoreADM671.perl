...
printf OUT "outfile:mixscore_shuffle671.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters671";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle671.out\n", $nsamples, $nsnps;
