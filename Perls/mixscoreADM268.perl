...
printf OUT "outfile:mixscore_shuffle268.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters268";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle268.out\n", $nsamples, $nsnps;
