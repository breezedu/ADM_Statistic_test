...
printf OUT "outfile:mixscore_shuffle992.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters992";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle992.out\n", $nsamples, $nsnps;
