...
printf OUT "outfile:mixscore_shuffle914.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters914";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle914.out\n", $nsamples, $nsnps;
