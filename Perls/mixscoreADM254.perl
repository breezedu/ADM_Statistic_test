...
printf OUT "outfile:mixscore_shuffle254.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters254";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle254.out\n", $nsamples, $nsnps;
