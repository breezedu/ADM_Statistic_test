...
printf OUT "outfile:mixscore_shuffle495.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters495";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle495.out\n", $nsamples, $nsnps;
