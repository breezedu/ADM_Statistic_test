...
printf OUT "outfile:mixscore_shuffle399.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters399";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle399.out\n", $nsamples, $nsnps;
