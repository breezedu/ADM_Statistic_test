...
printf OUT "outfile:mixscore_shuffle493.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters493";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle493.out\n", $nsamples, $nsnps;
