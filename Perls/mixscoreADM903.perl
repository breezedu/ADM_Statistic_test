...
printf OUT "outfile:mixscore_shuffle903.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters903";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle903.out\n", $nsamples, $nsnps;
