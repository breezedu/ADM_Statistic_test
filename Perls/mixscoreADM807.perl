...
printf OUT "outfile:mixscore_shuffle807.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters807";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle807.out\n", $nsamples, $nsnps;
