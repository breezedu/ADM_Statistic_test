...
printf OUT "outfile:mixscore_shuffle623.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters623";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle623.out\n", $nsamples, $nsnps;
