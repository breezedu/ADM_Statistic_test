...
printf OUT "outfile:mixscore_shuffle634.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters634";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle634.out\n", $nsamples, $nsnps;
