...
printf OUT "outfile:mixscore_shuffle767.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters767";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle767.out\n", $nsamples, $nsnps;
