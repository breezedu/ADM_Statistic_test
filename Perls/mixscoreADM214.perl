...
printf OUT "outfile:mixscore_shuffle214.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters214";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle214.out\n", $nsamples, $nsnps;
