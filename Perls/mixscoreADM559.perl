...
printf OUT "outfile:mixscore_shuffle559.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters559";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle559.out\n", $nsamples, $nsnps;
