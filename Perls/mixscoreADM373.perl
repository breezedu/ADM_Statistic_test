...
printf OUT "outfile:mixscore_shuffle373.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters373";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle373.out\n", $nsamples, $nsnps;
