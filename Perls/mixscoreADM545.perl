...
printf OUT "outfile:mixscore_shuffle545.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters545";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle545.out\n", $nsamples, $nsnps;
