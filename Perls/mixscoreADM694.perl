...
printf OUT "outfile:mixscore_shuffle694.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters694";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle694.out\n", $nsamples, $nsnps;
