...
printf OUT "outfile:mixscore_shuffle849.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters849";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle849.out\n", $nsamples, $nsnps;
