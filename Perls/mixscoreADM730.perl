...
printf OUT "outfile:mixscore_shuffle730.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters730";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle730.out\n", $nsamples, $nsnps;
