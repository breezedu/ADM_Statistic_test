...
printf OUT "outfile:mixscore_shuffle701.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters701";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle701.out\n", $nsamples, $nsnps;
