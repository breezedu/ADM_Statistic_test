...
printf OUT "outfile:mixscore_shuffle332.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters332";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle332.out\n", $nsamples, $nsnps;
