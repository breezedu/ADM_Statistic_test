...
printf OUT "outfile:mixscore_shuffle121.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters121";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle121.out\n", $nsamples, $nsnps;
