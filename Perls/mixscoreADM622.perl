...
printf OUT "outfile:mixscore_shuffle622.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters622";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle622.out\n", $nsamples, $nsnps;
