...
printf OUT "outfile:mixscore_shuffle157.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters157";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle157.out\n", $nsamples, $nsnps;
