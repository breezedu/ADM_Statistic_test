...
printf OUT "outfile:mixscore_shuffle134.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters134";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle134.out\n", $nsamples, $nsnps;
