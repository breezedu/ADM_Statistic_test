...
printf OUT "outfile:mixscore_shuffle215.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters215";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle215.out\n", $nsamples, $nsnps;
