...
printf OUT "outfile:mixscore_shuffle136.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters136";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle136.out\n", $nsamples, $nsnps;
