...
printf OUT "outfile:mixscore_shuffle147.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters147";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle147.out\n", $nsamples, $nsnps;
