...
printf OUT "outfile:mixscore_shuffle521.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters521";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle521.out\n", $nsamples, $nsnps;
