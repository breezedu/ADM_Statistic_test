...
printf OUT "outfile:mixscore_shuffle240.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters240";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle240.out\n", $nsamples, $nsnps;
