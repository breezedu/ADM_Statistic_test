...
printf OUT "outfile:mixscore_shuffle271.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters271";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle271.out\n", $nsamples, $nsnps;
