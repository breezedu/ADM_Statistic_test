...
printf OUT "outfile:mixscore_shuffle120.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters120";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle120.out\n", $nsamples, $nsnps;
