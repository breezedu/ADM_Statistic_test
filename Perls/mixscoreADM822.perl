...
printf OUT "outfile:mixscore_shuffle822.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters822";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle822.out\n", $nsamples, $nsnps;
