...
printf OUT "outfile:mixscore_shuffle731.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters731";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle731.out\n", $nsamples, $nsnps;
