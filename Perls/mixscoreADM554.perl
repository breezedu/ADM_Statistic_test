...
printf OUT "outfile:mixscore_shuffle554.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters554";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle554.out\n", $nsamples, $nsnps;
