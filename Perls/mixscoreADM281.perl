...
printf OUT "outfile:mixscore_shuffle281.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters281";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle281.out\n", $nsamples, $nsnps;
