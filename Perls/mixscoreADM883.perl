...
printf OUT "outfile:mixscore_shuffle883.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters883";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle883.out\n", $nsamples, $nsnps;
