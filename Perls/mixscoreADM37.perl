...
printf OUT "outfile:mixscore_shuffle37.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters37";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle37.out\n", $nsamples, $nsnps;
