...
printf OUT "outfile:mixscore_shuffle295.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters295";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle295.out\n", $nsamples, $nsnps;
