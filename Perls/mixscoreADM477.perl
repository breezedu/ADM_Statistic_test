...
printf OUT "outfile:mixscore_shuffle477.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters477";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle477.out\n", $nsamples, $nsnps;
