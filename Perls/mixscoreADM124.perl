...
printf OUT "outfile:mixscore_shuffle124.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters124";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle124.out\n", $nsamples, $nsnps;
