...
printf OUT "outfile:mixscore_shuffle460.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters460";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle460.out\n", $nsamples, $nsnps;
