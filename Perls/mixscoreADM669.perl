...
printf OUT "outfile:mixscore_shuffle669.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters669";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle669.out\n", $nsamples, $nsnps;
