...
printf OUT "outfile:mixscore_shuffle392.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters392";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle392.out\n", $nsamples, $nsnps;
