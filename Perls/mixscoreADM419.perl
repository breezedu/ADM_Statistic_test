...
printf OUT "outfile:mixscore_shuffle419.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters419";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle419.out\n", $nsamples, $nsnps;
