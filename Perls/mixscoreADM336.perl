...
printf OUT "outfile:mixscore_shuffle336.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters336";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle336.out\n", $nsamples, $nsnps;
