...
printf OUT "outfile:mixscore_shuffle257.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters257";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle257.out\n", $nsamples, $nsnps;
