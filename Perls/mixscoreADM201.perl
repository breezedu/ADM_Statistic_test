...
printf OUT "outfile:mixscore_shuffle201.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters201";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle201.out\n", $nsamples, $nsnps;
