...
printf OUT "outfile:mixscore_shuffle512.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters512";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle512.out\n", $nsamples, $nsnps;
