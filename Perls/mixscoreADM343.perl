...
printf OUT "outfile:mixscore_shuffle343.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters343";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle343.out\n", $nsamples, $nsnps;
