...
printf OUT "outfile:mixscore_shuffle532.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters532";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle532.out\n", $nsamples, $nsnps;
