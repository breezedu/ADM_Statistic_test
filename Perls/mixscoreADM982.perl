...
printf OUT "outfile:mixscore_shuffle982.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters982";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle982.out\n", $nsamples, $nsnps;
