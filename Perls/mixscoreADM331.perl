...
printf OUT "outfile:mixscore_shuffle331.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters331";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle331.out\n", $nsamples, $nsnps;
