...
printf OUT "outfile:mixscore_shuffle899.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters899";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle899.out\n", $nsamples, $nsnps;
