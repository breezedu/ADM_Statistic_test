...
printf OUT "outfile:mixscore_shuffle916.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters916";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle916.out\n", $nsamples, $nsnps;
