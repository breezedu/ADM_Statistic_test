...
printf OUT "outfile:mixscore_shuffle837.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters837";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle837.out\n", $nsamples, $nsnps;
