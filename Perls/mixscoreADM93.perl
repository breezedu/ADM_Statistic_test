...
printf OUT "outfile:mixscore_shuffle93.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters93";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle93.out\n", $nsamples, $nsnps;
