...
printf OUT "outfile:mixscore_shuffle350.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters350";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle350.out\n", $nsamples, $nsnps;
