...
printf OUT "outfile:mixscore_shuffle337.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters337";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle337.out\n", $nsamples, $nsnps;
