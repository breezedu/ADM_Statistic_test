...
printf OUT "outfile:mixscore_shuffle946.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters946";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle946.out\n", $nsamples, $nsnps;
