...
printf OUT "outfile:mixscore_shuffle238.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters238";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle238.out\n", $nsamples, $nsnps;
