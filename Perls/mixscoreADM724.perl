...
printf OUT "outfile:mixscore_shuffle724.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters724";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle724.out\n", $nsamples, $nsnps;
