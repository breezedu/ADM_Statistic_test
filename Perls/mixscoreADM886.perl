...
printf OUT "outfile:mixscore_shuffle886.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters886";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle886.out\n", $nsamples, $nsnps;
