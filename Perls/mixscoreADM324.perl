...
printf OUT "outfile:mixscore_shuffle324.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters324";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle324.out\n", $nsamples, $nsnps;
