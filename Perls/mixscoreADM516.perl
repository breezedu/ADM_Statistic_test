...
printf OUT "outfile:mixscore_shuffle516.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters516";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle516.out\n", $nsamples, $nsnps;
