...
printf OUT "outfile:mixscore_shuffle981.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters981";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle981.out\n", $nsamples, $nsnps;
