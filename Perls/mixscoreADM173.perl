...
printf OUT "outfile:mixscore_shuffle173.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters173";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle173.out\n", $nsamples, $nsnps;
