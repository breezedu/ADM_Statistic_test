...
printf OUT "outfile:mixscore_shuffle220.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters220";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle220.out\n", $nsamples, $nsnps;
