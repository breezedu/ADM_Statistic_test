...
printf OUT "outfile:mixscore_shuffle844.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters844";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle844.out\n", $nsamples, $nsnps;
