...
printf OUT "outfile:mixscore_shuffle206.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters206";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle206.out\n", $nsamples, $nsnps;
