...
printf OUT "outfile:mixscore_shuffle737.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters737";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle737.out\n", $nsamples, $nsnps;
