...
printf OUT "outfile:mixscore_shuffle413.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters413";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle413.out\n", $nsamples, $nsnps;
