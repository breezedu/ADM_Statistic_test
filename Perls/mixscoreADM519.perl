...
printf OUT "outfile:mixscore_shuffle519.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters519";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle519.out\n", $nsamples, $nsnps;
