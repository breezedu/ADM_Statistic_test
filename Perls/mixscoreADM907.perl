...
printf OUT "outfile:mixscore_shuffle907.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters907";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle907.out\n", $nsamples, $nsnps;
