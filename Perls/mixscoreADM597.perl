...
printf OUT "outfile:mixscore_shuffle597.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters597";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle597.out\n", $nsamples, $nsnps;
