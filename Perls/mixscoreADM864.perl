...
printf OUT "outfile:mixscore_shuffle864.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters864";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle864.out\n", $nsamples, $nsnps;
