...
printf OUT "outfile:mixscore_shuffle444.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters444";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle444.out\n", $nsamples, $nsnps;
