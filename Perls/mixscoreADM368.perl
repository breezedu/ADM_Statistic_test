...
printf OUT "outfile:mixscore_shuffle368.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters368";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle368.out\n", $nsamples, $nsnps;
