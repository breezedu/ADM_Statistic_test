...
printf OUT "outfile:mixscore_shuffle323.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters323";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle323.out\n", $nsamples, $nsnps;
