...
printf OUT "outfile:mixscore_shuffle511.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters511";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle511.out\n", $nsamples, $nsnps;
