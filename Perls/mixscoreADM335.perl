...
printf OUT "outfile:mixscore_shuffle335.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters335";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle335.out\n", $nsamples, $nsnps;
