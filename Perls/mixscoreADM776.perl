...
printf OUT "outfile:mixscore_shuffle776.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters776";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle776.out\n", $nsamples, $nsnps;
