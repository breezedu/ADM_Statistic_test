...
printf OUT "outfile:mixscore_shuffle637.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters637";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle637.out\n", $nsamples, $nsnps;
