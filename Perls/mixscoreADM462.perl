...
printf OUT "outfile:mixscore_shuffle462.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters462";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle462.out\n", $nsamples, $nsnps;
