...
printf OUT "outfile:mixscore_shuffle391.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters391";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle391.out\n", $nsamples, $nsnps;
