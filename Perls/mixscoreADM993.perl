...
printf OUT "outfile:mixscore_shuffle993.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters993";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle993.out\n", $nsamples, $nsnps;
