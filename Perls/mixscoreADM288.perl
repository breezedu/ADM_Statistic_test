...
printf OUT "outfile:mixscore_shuffle288.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters288";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle288.out\n", $nsamples, $nsnps;
