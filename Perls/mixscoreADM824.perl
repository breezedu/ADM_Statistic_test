...
printf OUT "outfile:mixscore_shuffle824.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters824";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle824.out\n", $nsamples, $nsnps;
