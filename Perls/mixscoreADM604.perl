...
printf OUT "outfile:mixscore_shuffle604.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters604";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle604.out\n", $nsamples, $nsnps;
