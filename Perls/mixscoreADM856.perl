...
printf OUT "outfile:mixscore_shuffle856.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters856";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle856.out\n", $nsamples, $nsnps;
