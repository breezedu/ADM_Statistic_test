...
printf OUT "outfile:mixscore_shuffle543.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters543";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle543.out\n", $nsamples, $nsnps;
