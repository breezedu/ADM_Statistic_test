...
printf OUT "outfile:mixscore_shuffle602.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters602";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle602.out\n", $nsamples, $nsnps;
