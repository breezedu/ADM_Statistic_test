...
printf OUT "outfile:mixscore_shuffle339.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters339";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle339.out\n", $nsamples, $nsnps;
