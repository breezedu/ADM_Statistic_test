...
printf OUT "outfile:mixscore_shuffle919.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters919";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle919.out\n", $nsamples, $nsnps;
