...
printf OUT "outfile:mixscore_shuffle566.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters566";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle566.out\n", $nsamples, $nsnps;
