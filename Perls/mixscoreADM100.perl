...
printf OUT "outfile:mixscore_shuffle100.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters100";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle100.out\n", $nsamples, $nsnps;
