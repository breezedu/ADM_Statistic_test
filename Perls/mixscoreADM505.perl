...
printf OUT "outfile:mixscore_shuffle505.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters505";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle505.out\n", $nsamples, $nsnps;
