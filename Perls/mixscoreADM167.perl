...
printf OUT "outfile:mixscore_shuffle167.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters167";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle167.out\n", $nsamples, $nsnps;
