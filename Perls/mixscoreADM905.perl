...
printf OUT "outfile:mixscore_shuffle905.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters905";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle905.out\n", $nsamples, $nsnps;
