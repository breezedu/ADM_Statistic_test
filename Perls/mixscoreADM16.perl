...
printf OUT "outfile:mixscore_shuffle16.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters16";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle16.out\n", $nsamples, $nsnps;
