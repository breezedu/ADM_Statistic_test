...
printf OUT "outfile:mixscore_shuffle784.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters784";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle784.out\n", $nsamples, $nsnps;
