...
printf OUT "outfile:mixscore_shuffle154.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters154";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle154.out\n", $nsamples, $nsnps;
