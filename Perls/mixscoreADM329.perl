...
printf OUT "outfile:mixscore_shuffle329.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters329";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle329.out\n", $nsamples, $nsnps;
