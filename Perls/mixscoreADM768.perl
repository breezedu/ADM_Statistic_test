...
printf OUT "outfile:mixscore_shuffle768.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters768";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle768.out\n", $nsamples, $nsnps;
