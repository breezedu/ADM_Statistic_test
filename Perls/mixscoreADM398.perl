...
printf OUT "outfile:mixscore_shuffle398.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters398";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle398.out\n", $nsamples, $nsnps;
