...
printf OUT "outfile:mixscore_shuffle1.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters1";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle1.out\n", $nsamples, $nsnps;
