...
printf OUT "outfile:mixscore_shuffle885.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters885";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle885.out\n", $nsamples, $nsnps;
