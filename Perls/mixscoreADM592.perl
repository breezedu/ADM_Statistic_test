...
printf OUT "outfile:mixscore_shuffle592.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters592";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle592.out\n", $nsamples, $nsnps;
