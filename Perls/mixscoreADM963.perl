...
printf OUT "outfile:mixscore_shuffle963.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters963";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle963.out\n", $nsamples, $nsnps;
