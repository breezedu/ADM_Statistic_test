...
printf OUT "outfile:mixscore_shuffle296.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters296";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle296.out\n", $nsamples, $nsnps;
