...
printf OUT "outfile:mixscore_shuffle843.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters843";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle843.out\n", $nsamples, $nsnps;
