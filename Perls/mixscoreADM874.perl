...
printf OUT "outfile:mixscore_shuffle874.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters874";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle874.out\n", $nsamples, $nsnps;
