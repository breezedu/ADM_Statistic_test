...
printf OUT "outfile:mixscore_shuffle873.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters873";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle873.out\n", $nsamples, $nsnps;
