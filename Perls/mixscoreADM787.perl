...
printf OUT "outfile:mixscore_shuffle787.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters787";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle787.out\n", $nsamples, $nsnps;
