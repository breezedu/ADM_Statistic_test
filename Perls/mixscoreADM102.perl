...
printf OUT "outfile:mixscore_shuffle102.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters102";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle102.out\n", $nsamples, $nsnps;
