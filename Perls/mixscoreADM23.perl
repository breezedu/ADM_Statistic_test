...
printf OUT "outfile:mixscore_shuffle23.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters23";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle23.out\n", $nsamples, $nsnps;
