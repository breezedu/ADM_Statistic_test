...
printf OUT "outfile:mixscore_shuffle811.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters811";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle811.out\n", $nsamples, $nsnps;
