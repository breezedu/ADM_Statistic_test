...
printf OUT "outfile:mixscore_shuffle32.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters32";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle32.out\n", $nsamples, $nsnps;
