...
printf OUT "outfile:mixscore_shuffle371.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters371";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle371.out\n", $nsamples, $nsnps;
