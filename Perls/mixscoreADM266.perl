...
printf OUT "outfile:mixscore_shuffle266.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters266";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle266.out\n", $nsamples, $nsnps;
