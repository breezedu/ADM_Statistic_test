...
printf OUT "outfile:mixscore_shuffle941.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters941";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle941.out\n", $nsamples, $nsnps;
