...
printf OUT "outfile:mixscore_shuffle131.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters131";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle131.out\n", $nsamples, $nsnps;
