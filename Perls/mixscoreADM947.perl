...
printf OUT "outfile:mixscore_shuffle947.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters947";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle947.out\n", $nsamples, $nsnps;
