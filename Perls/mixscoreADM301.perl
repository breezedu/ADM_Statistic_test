...
printf OUT "outfile:mixscore_shuffle301.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters301";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle301.out\n", $nsamples, $nsnps;
