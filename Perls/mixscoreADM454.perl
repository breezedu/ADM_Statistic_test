...
printf OUT "outfile:mixscore_shuffle454.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters454";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle454.out\n", $nsamples, $nsnps;
