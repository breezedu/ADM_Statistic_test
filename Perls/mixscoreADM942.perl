...
printf OUT "outfile:mixscore_shuffle942.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters942";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle942.out\n", $nsamples, $nsnps;
