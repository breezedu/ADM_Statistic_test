...
printf OUT "outfile:mixscore_shuffle683.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters683";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle683.out\n", $nsamples, $nsnps;
