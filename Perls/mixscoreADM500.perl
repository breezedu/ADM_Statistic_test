...
printf OUT "outfile:mixscore_shuffle500.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters500";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle500.out\n", $nsamples, $nsnps;
