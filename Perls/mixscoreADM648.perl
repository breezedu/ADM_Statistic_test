...
printf OUT "outfile:mixscore_shuffle648.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters648";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle648.out\n", $nsamples, $nsnps;
