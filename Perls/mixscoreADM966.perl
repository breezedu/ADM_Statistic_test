...
printf OUT "outfile:mixscore_shuffle966.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters966";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle966.out\n", $nsamples, $nsnps;
