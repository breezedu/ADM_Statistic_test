...
printf OUT "outfile:mixscore_shuffle584.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters584";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle584.out\n", $nsamples, $nsnps;
