...
printf OUT "outfile:mixscore_shuffle668.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters668";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle668.out\n", $nsamples, $nsnps;
