...
printf OUT "outfile:mixscore_shuffle705.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters705";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle705.out\n", $nsamples, $nsnps;
