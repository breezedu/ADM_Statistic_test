...
printf OUT "outfile:mixscore_shuffle402.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters402";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle402.out\n", $nsamples, $nsnps;
