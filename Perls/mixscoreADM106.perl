...
printf OUT "outfile:mixscore_shuffle106.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters106";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle106.out\n", $nsamples, $nsnps;
