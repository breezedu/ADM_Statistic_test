...
printf OUT "outfile:mixscore_shuffle655.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters655";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle655.out\n", $nsamples, $nsnps;
