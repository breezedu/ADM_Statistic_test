...
printf OUT "outfile:mixscore_shuffle291.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters291";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle291.out\n", $nsamples, $nsnps;
