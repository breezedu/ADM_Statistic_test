...
printf OUT "outfile:mixscore_shuffle394.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters394";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle394.out\n", $nsamples, $nsnps;
