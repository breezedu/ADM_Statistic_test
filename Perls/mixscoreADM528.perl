...
printf OUT "outfile:mixscore_shuffle528.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters528";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle528.out\n", $nsamples, $nsnps;
