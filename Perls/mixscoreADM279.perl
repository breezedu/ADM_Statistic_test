...
printf OUT "outfile:mixscore_shuffle279.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters279";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle279.out\n", $nsamples, $nsnps;
