...
printf OUT "outfile:mixscore_shuffle318.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters318";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle318.out\n", $nsamples, $nsnps;
