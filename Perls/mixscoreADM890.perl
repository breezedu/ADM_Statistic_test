...
printf OUT "outfile:mixscore_shuffle890.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters890";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle890.out\n", $nsamples, $nsnps;
