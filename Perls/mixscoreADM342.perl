...
printf OUT "outfile:mixscore_shuffle342.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters342";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle342.out\n", $nsamples, $nsnps;
