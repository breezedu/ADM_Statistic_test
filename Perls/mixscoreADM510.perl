...
printf OUT "outfile:mixscore_shuffle510.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters510";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle510.out\n", $nsamples, $nsnps;
