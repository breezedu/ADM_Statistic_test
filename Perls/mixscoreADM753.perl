...
printf OUT "outfile:mixscore_shuffle753.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters753";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle753.out\n", $nsamples, $nsnps;
