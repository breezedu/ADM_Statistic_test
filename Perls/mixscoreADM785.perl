...
printf OUT "outfile:mixscore_shuffle785.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters785";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle785.out\n", $nsamples, $nsnps;
