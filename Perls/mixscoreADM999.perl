...
printf OUT "outfile:mixscore_shuffle999.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters999";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle999.out\n", $nsamples, $nsnps;
