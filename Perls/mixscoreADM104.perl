...
printf OUT "outfile:mixscore_shuffle104.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters104";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle104.out\n", $nsamples, $nsnps;
