...
printf OUT "outfile:mixscore_shuffle908.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters908";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle908.out\n", $nsamples, $nsnps;
