...
printf OUT "outfile:mixscore_shuffle78.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters78";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle78.out\n", $nsamples, $nsnps;
