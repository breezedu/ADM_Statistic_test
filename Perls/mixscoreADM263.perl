...
printf OUT "outfile:mixscore_shuffle263.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters263";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle263.out\n", $nsamples, $nsnps;
