...
printf OUT "outfile:mixscore_shuffle193.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters193";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle193.out\n", $nsamples, $nsnps;
