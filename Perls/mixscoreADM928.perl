...
printf OUT "outfile:mixscore_shuffle928.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters928";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle928.out\n", $nsamples, $nsnps;
