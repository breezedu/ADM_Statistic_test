...
printf OUT "outfile:mixscore_shuffle469.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters469";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle469.out\n", $nsamples, $nsnps;
