...
printf OUT "outfile:mixscore_shuffle515.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters515";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle515.out\n", $nsamples, $nsnps;
