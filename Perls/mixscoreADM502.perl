...
printf OUT "outfile:mixscore_shuffle502.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters502";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle502.out\n", $nsamples, $nsnps;
