...
printf OUT "outfile:mixscore_shuffle952.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters952";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle952.out\n", $nsamples, $nsnps;
