...
printf OUT "outfile:mixscore_shuffle628.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters628";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle628.out\n", $nsamples, $nsnps;
