...
printf OUT "outfile:mixscore_shuffle457.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters457";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle457.out\n", $nsamples, $nsnps;
