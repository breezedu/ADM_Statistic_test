...
printf OUT "outfile:mixscore_shuffle572.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters572";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle572.out\n", $nsamples, $nsnps;
