...
printf OUT "outfile:mixscore_shuffle307.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters307";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle307.out\n", $nsamples, $nsnps;
