...
printf OUT "outfile:mixscore_shuffle794.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters794";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle794.out\n", $nsamples, $nsnps;
