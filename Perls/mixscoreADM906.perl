...
printf OUT "outfile:mixscore_shuffle906.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters906";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle906.out\n", $nsamples, $nsnps;
