...
printf OUT "outfile:mixscore_shuffle364.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters364";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle364.out\n", $nsamples, $nsnps;
