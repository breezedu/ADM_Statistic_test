...
printf OUT "outfile:mixscore_shuffle994.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters994";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle994.out\n", $nsamples, $nsnps;
