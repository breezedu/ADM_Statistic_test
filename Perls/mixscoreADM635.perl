...
printf OUT "outfile:mixscore_shuffle635.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters635";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle635.out\n", $nsamples, $nsnps;
