...
printf OUT "outfile:mixscore_shuffle12.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters12";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle12.out\n", $nsamples, $nsnps;
