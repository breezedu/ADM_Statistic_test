...
printf OUT "outfile:mixscore_shuffle310.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters310";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle310.out\n", $nsamples, $nsnps;
