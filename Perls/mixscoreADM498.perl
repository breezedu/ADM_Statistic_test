...
printf OUT "outfile:mixscore_shuffle498.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters498";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle498.out\n", $nsamples, $nsnps;
