...
printf OUT "outfile:mixscore_shuffle889.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters889";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle889.out\n", $nsamples, $nsnps;
