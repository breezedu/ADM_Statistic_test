...
printf OUT "outfile:mixscore_shuffle662.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters662";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle662.out\n", $nsamples, $nsnps;
