...
printf OUT "outfile:mixscore_shuffle76.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters76";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle76.out\n", $nsamples, $nsnps;
