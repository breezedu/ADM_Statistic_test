...
printf OUT "outfile:mixscore_shuffle401.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters401";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle401.out\n", $nsamples, $nsnps;
