...
printf OUT "outfile:mixscore_shuffle107.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters107";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle107.out\n", $nsamples, $nsnps;
