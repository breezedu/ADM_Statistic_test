...
printf OUT "outfile:mixscore_shuffle218.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters218";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle218.out\n", $nsamples, $nsnps;
