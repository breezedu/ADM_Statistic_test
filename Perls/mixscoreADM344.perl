...
printf OUT "outfile:mixscore_shuffle344.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters344";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle344.out\n", $nsamples, $nsnps;
