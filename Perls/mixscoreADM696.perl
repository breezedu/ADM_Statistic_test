...
printf OUT "outfile:mixscore_shuffle696.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters696";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle696.out\n", $nsamples, $nsnps;
