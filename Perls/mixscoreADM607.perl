...
printf OUT "outfile:mixscore_shuffle607.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters607";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle607.out\n", $nsamples, $nsnps;
