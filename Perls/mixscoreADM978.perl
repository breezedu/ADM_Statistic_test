...
printf OUT "outfile:mixscore_shuffle978.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters978";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle978.out\n", $nsamples, $nsnps;
