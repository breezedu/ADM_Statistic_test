...
printf OUT "outfile:mixscore_shuffle113.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters113";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle113.out\n", $nsamples, $nsnps;
