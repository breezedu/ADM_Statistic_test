...
printf OUT "outfile:mixscore_shuffle579.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters579";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle579.out\n", $nsamples, $nsnps;
