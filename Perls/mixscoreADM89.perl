...
printf OUT "outfile:mixscore_shuffle89.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters89";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle89.out\n", $nsamples, $nsnps;
