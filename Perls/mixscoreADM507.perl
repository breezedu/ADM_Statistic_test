...
printf OUT "outfile:mixscore_shuffle507.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters507";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle507.out\n", $nsamples, $nsnps;
