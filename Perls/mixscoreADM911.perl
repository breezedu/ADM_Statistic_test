...
printf OUT "outfile:mixscore_shuffle911.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters911";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle911.out\n", $nsamples, $nsnps;
