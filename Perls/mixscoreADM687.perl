...
printf OUT "outfile:mixscore_shuffle687.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters687";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle687.out\n", $nsamples, $nsnps;
