...
printf OUT "outfile:mixscore_shuffle564.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters564";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle564.out\n", $nsamples, $nsnps;
