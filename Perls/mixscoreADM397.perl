...
printf OUT "outfile:mixscore_shuffle397.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters397";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle397.out\n", $nsamples, $nsnps;
