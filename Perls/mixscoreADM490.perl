...
printf OUT "outfile:mixscore_shuffle490.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters490";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle490.out\n", $nsamples, $nsnps;
