...
printf OUT "outfile:mixscore_shuffle792.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters792";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle792.out\n", $nsamples, $nsnps;
