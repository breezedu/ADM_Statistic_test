...
printf OUT "outfile:mixscore_shuffle476.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters476";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle476.out\n", $nsamples, $nsnps;
