...
printf OUT "outfile:mixscore_shuffle948.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters948";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle948.out\n", $nsamples, $nsnps;
