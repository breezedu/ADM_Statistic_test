...
printf OUT "outfile:mixscore_shuffle260.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters260";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle260.out\n", $nsamples, $nsnps;
