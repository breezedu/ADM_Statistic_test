...
printf OUT "outfile:mixscore_shuffle92.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters92";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle92.out\n", $nsamples, $nsnps;
