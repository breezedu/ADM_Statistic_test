...
printf OUT "outfile:mixscore_shuffle357.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters357";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle357.out\n", $nsamples, $nsnps;
