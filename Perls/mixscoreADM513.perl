...
printf OUT "outfile:mixscore_shuffle513.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters513";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle513.out\n", $nsamples, $nsnps;
