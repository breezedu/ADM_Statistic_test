...
printf OUT "outfile:mixscore_shuffle867.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters867";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle867.out\n", $nsamples, $nsnps;
