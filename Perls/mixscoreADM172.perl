...
printf OUT "outfile:mixscore_shuffle172.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters172";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle172.out\n", $nsamples, $nsnps;
