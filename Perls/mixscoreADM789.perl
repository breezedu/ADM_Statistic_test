...
printf OUT "outfile:mixscore_shuffle789.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters789";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle789.out\n", $nsamples, $nsnps;
