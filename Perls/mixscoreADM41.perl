...
printf OUT "outfile:mixscore_shuffle41.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters41";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle41.out\n", $nsamples, $nsnps;
