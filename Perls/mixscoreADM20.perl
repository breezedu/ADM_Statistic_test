...
printf OUT "outfile:mixscore_shuffle20.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters20";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle20.out\n", $nsamples, $nsnps;
