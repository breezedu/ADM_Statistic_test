...
printf OUT "outfile:mixscore_shuffle248.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters248";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle248.out\n", $nsamples, $nsnps;
