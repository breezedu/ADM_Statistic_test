...
printf OUT "outfile:mixscore_shuffle138.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters138";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle138.out\n", $nsamples, $nsnps;
