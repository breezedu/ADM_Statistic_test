...
printf OUT "outfile:mixscore_shuffle428.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters428";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle428.out\n", $nsamples, $nsnps;
