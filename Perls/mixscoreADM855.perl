...
printf OUT "outfile:mixscore_shuffle855.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters855";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle855.out\n", $nsamples, $nsnps;
