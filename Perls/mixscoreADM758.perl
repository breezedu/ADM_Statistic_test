...
printf OUT "outfile:mixscore_shuffle758.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters758";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle758.out\n", $nsamples, $nsnps;
