...
printf OUT "outfile:mixscore_shuffle367.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters367";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle367.out\n", $nsamples, $nsnps;
