...
printf OUT "outfile:mixscore_shuffle46.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters46";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle46.out\n", $nsamples, $nsnps;
