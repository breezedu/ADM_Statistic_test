...
printf OUT "outfile:mixscore_shuffle613.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters613";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle613.out\n", $nsamples, $nsnps;
