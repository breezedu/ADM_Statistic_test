...
printf OUT "outfile:mixscore_shuffle95.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters95";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle95.out\n", $nsamples, $nsnps;
