...
printf OUT "outfile:mixscore_shuffle272.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters272";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle272.out\n", $nsamples, $nsnps;
