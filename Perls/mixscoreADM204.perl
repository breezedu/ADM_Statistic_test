...
printf OUT "outfile:mixscore_shuffle204.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters204";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle204.out\n", $nsamples, $nsnps;
