...
printf OUT "outfile:mixscore_shuffle346.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters346";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle346.out\n", $nsamples, $nsnps;
