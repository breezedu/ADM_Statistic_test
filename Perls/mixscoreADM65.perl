...
printf OUT "outfile:mixscore_shuffle65.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters65";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle65.out\n", $nsamples, $nsnps;
