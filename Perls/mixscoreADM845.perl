...
printf OUT "outfile:mixscore_shuffle845.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters845";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle845.out\n", $nsamples, $nsnps;
