...
printf OUT "outfile:mixscore_shuffle273.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters273";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle273.out\n", $nsamples, $nsnps;
