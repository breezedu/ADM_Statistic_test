...
printf OUT "outfile:mixscore_shuffle438.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters438";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle438.out\n", $nsamples, $nsnps;
