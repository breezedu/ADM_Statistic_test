...
printf OUT "outfile:mixscore_shuffle320.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters320";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle320.out\n", $nsamples, $nsnps;
