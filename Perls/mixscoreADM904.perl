...
printf OUT "outfile:mixscore_shuffle904.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters904";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle904.out\n", $nsamples, $nsnps;
