...
printf OUT "outfile:mixscore_shuffle936.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters936";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle936.out\n", $nsamples, $nsnps;
