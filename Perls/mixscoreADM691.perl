...
printf OUT "outfile:mixscore_shuffle691.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters691";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle691.out\n", $nsamples, $nsnps;
