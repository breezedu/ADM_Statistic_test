...
printf OUT "outfile:mixscore_shuffle573.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters573";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle573.out\n", $nsamples, $nsnps;
