...
printf OUT "outfile:mixscore_shuffle858.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters858";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle858.out\n", $nsamples, $nsnps;
