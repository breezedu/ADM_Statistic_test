...
printf OUT "outfile:mixscore_shuffle299.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters299";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle299.out\n", $nsamples, $nsnps;
