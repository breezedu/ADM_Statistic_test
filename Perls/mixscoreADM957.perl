...
printf OUT "outfile:mixscore_shuffle957.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters957";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle957.out\n", $nsamples, $nsnps;
