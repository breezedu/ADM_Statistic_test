...
printf OUT "outfile:mixscore_shuffle700.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters700";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle700.out\n", $nsamples, $nsnps;
