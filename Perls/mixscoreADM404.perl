...
printf OUT "outfile:mixscore_shuffle404.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters404";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle404.out\n", $nsamples, $nsnps;
