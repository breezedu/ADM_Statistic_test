...
printf OUT "outfile:mixscore_shuffle132.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters132";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle132.out\n", $nsamples, $nsnps;
