...
printf OUT "outfile:mixscore_shuffle80.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters80";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle80.out\n", $nsamples, $nsnps;
