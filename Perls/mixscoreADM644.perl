...
printf OUT "outfile:mixscore_shuffle644.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters644";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle644.out\n", $nsamples, $nsnps;
