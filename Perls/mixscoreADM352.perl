...
printf OUT "outfile:mixscore_shuffle352.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters352";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle352.out\n", $nsamples, $nsnps;
