...
printf OUT "outfile:mixscore_shuffle29.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters29";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle29.out\n", $nsamples, $nsnps;
