...
printf OUT "outfile:mixscore_shuffle880.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters880";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle880.out\n", $nsamples, $nsnps;
