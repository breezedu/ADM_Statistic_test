...
printf OUT "outfile:mixscore_shuffle361.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters361";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle361.out\n", $nsamples, $nsnps;
