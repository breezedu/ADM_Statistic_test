...
printf OUT "outfile:mixscore_shuffle514.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters514";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle514.out\n", $nsamples, $nsnps;
