...
printf OUT "outfile:mixscore_shuffle369.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters369";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle369.out\n", $nsamples, $nsnps;
