...
printf OUT "outfile:mixscore_shuffle236.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters236";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle236.out\n", $nsamples, $nsnps;
