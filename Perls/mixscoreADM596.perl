...
printf OUT "outfile:mixscore_shuffle596.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters596";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle596.out\n", $nsamples, $nsnps;
