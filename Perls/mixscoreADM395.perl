...
printf OUT "outfile:mixscore_shuffle395.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters395";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle395.out\n", $nsamples, $nsnps;
