...
printf OUT "outfile:mixscore_shuffle934.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters934";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle934.out\n", $nsamples, $nsnps;
