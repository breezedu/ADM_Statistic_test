...
printf OUT "outfile:mixscore_shuffle863.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters863";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle863.out\n", $nsamples, $nsnps;
