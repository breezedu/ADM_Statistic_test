...
printf OUT "outfile:mixscore_shuffle719.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters719";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle719.out\n", $nsamples, $nsnps;
