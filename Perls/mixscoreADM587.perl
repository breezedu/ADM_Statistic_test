...
printf OUT "outfile:mixscore_shuffle587.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters587";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle587.out\n", $nsamples, $nsnps;
