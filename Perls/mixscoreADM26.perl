...
printf OUT "outfile:mixscore_shuffle26.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters26";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle26.out\n", $nsamples, $nsnps;
