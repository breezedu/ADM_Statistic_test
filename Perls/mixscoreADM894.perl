...
printf OUT "outfile:mixscore_shuffle894.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters894";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle894.out\n", $nsamples, $nsnps;
