...
printf OUT "outfile:mixscore_shuffle535.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters535";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle535.out\n", $nsamples, $nsnps;
