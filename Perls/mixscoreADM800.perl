...
printf OUT "outfile:mixscore_shuffle800.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters800";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle800.out\n", $nsamples, $nsnps;
