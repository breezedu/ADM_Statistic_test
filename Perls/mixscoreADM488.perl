...
printf OUT "outfile:mixscore_shuffle488.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters488";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle488.out\n", $nsamples, $nsnps;
