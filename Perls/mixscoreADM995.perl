...
printf OUT "outfile:mixscore_shuffle995.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters995";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle995.out\n", $nsamples, $nsnps;
