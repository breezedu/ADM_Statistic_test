...
printf OUT "outfile:mixscore_shuffle755.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters755";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle755.out\n", $nsamples, $nsnps;
