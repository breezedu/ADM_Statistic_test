...
printf OUT "outfile:mixscore_shuffle250.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters250";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle250.out\n", $nsamples, $nsnps;
