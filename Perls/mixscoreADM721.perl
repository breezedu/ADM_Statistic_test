...
printf OUT "outfile:mixscore_shuffle721.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters721";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle721.out\n", $nsamples, $nsnps;
