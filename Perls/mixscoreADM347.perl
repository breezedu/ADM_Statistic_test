...
printf OUT "outfile:mixscore_shuffle347.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters347";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle347.out\n", $nsamples, $nsnps;
