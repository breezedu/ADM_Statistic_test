...
printf OUT "outfile:mixscore_shuffle958.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters958";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle958.out\n", $nsamples, $nsnps;
