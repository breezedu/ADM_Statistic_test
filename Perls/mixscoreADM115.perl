...
printf OUT "outfile:mixscore_shuffle115.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters115";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle115.out\n", $nsamples, $nsnps;
