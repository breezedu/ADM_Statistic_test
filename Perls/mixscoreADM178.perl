...
printf OUT "outfile:mixscore_shuffle178.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters178";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle178.out\n", $nsamples, $nsnps;
