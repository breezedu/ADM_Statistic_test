...
printf OUT "outfile:mixscore_shuffle567.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters567";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle567.out\n", $nsamples, $nsnps;
