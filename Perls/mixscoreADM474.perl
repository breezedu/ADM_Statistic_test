...
printf OUT "outfile:mixscore_shuffle474.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters474";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle474.out\n", $nsamples, $nsnps;
