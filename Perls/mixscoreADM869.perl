...
printf OUT "outfile:mixscore_shuffle869.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters869";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle869.out\n", $nsamples, $nsnps;
