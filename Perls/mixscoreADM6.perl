...
printf OUT "outfile:mixscore_shuffle6.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters6";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle6.out\n", $nsamples, $nsnps;
