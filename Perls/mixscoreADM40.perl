...
printf OUT "outfile:mixscore_shuffle40.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters40";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle40.out\n", $nsamples, $nsnps;
