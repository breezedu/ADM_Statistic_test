...
printf OUT "outfile:mixscore_shuffle437.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters437";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle437.out\n", $nsamples, $nsnps;
