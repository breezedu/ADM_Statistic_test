...
printf OUT "outfile:mixscore_shuffle766.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters766";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle766.out\n", $nsamples, $nsnps;
