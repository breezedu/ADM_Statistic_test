...
printf OUT "outfile:mixscore_shuffle830.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters830";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle830.out\n", $nsamples, $nsnps;
