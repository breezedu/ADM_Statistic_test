...
printf OUT "outfile:mixscore_shuffle217.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters217";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle217.out\n", $nsamples, $nsnps;
