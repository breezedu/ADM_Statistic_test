...
printf OUT "outfile:mixscore_shuffle305.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters305";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle305.out\n", $nsamples, $nsnps;
