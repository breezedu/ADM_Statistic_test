...
printf OUT "outfile:mixscore_shuffle430.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters430";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle430.out\n", $nsamples, $nsnps;
