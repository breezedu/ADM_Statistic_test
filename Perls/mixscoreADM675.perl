...
printf OUT "outfile:mixscore_shuffle675.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters675";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle675.out\n", $nsamples, $nsnps;
