...
printf OUT "outfile:mixscore_shuffle388.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters388";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle388.out\n", $nsamples, $nsnps;
