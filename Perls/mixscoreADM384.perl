...
printf OUT "outfile:mixscore_shuffle384.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters384";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle384.out\n", $nsamples, $nsnps;
