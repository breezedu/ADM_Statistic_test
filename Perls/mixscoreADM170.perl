...
printf OUT "outfile:mixscore_shuffle170.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters170";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle170.out\n", $nsamples, $nsnps;
