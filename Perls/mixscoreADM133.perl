...
printf OUT "outfile:mixscore_shuffle133.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters133";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle133.out\n", $nsamples, $nsnps;
