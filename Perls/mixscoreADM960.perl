...
printf OUT "outfile:mixscore_shuffle960.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters960";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle960.out\n", $nsamples, $nsnps;
