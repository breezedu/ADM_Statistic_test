...
printf OUT "outfile:mixscore_shuffle403.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters403";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle403.out\n", $nsamples, $nsnps;
