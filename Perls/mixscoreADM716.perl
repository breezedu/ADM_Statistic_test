...
printf OUT "outfile:mixscore_shuffle716.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters716";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle716.out\n", $nsamples, $nsnps;
