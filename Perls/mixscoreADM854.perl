...
printf OUT "outfile:mixscore_shuffle854.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters854";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle854.out\n", $nsamples, $nsnps;
