...
printf OUT "outfile:mixscore_shuffle624.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters624";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle624.out\n", $nsamples, $nsnps;
