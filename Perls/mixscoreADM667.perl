...
printf OUT "outfile:mixscore_shuffle667.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters667";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle667.out\n", $nsamples, $nsnps;
