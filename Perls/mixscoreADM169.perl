...
printf OUT "outfile:mixscore_shuffle169.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters169";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle169.out\n", $nsamples, $nsnps;
