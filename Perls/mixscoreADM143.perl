...
printf OUT "outfile:mixscore_shuffle143.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters143";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle143.out\n", $nsamples, $nsnps;
