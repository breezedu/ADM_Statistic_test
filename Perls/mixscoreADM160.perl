...
printf OUT "outfile:mixscore_shuffle160.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters160";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle160.out\n", $nsamples, $nsnps;
