...
printf OUT "outfile:mixscore_shuffle658.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters658";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle658.out\n", $nsamples, $nsnps;
