...
printf OUT "outfile:mixscore_shuffle754.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters754";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle754.out\n", $nsamples, $nsnps;
