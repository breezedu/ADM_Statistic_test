...
printf OUT "outfile:mixscore_shuffle870.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters870";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle870.out\n", $nsamples, $nsnps;
