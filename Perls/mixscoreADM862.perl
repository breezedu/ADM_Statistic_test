...
printf OUT "outfile:mixscore_shuffle862.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters862";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle862.out\n", $nsamples, $nsnps;
