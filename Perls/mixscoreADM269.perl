...
printf OUT "outfile:mixscore_shuffle269.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters269";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle269.out\n", $nsamples, $nsnps;
