...
printf OUT "outfile:mixscore_shuffle166.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters166";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle166.out\n", $nsamples, $nsnps;
