...
printf OUT "outfile:mixscore_shuffle961.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters961";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle961.out\n", $nsamples, $nsnps;
