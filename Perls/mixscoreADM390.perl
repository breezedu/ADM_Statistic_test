...
printf OUT "outfile:mixscore_shuffle390.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters390";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle390.out\n", $nsamples, $nsnps;
