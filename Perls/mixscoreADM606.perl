...
printf OUT "outfile:mixscore_shuffle606.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters606";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle606.out\n", $nsamples, $nsnps;
