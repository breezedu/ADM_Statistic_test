...
printf OUT "outfile:mixscore_shuffle447.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters447";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle447.out\n", $nsamples, $nsnps;
