...
printf OUT "outfile:mixscore_shuffle955.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters955";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle955.out\n", $nsamples, $nsnps;
