...
printf OUT "outfile:mixscore_shuffle775.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters775";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle775.out\n", $nsamples, $nsnps;
