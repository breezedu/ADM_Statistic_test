...
printf OUT "outfile:mixscore_shuffle859.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters859";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle859.out\n", $nsamples, $nsnps;
