...
printf OUT "outfile:mixscore_shuffle216.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters216";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle216.out\n", $nsamples, $nsnps;
