...
printf OUT "outfile:mixscore_shuffle560.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters560";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle560.out\n", $nsamples, $nsnps;
