...
printf OUT "outfile:mixscore_shuffle24.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters24";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle24.out\n", $nsamples, $nsnps;
