...
printf OUT "outfile:mixscore_shuffle736.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters736";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle736.out\n", $nsamples, $nsnps;
