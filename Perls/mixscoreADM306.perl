...
printf OUT "outfile:mixscore_shuffle306.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters306";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle306.out\n", $nsamples, $nsnps;
