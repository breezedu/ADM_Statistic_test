...
printf OUT "outfile:mixscore_shuffle42.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters42";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle42.out\n", $nsamples, $nsnps;
