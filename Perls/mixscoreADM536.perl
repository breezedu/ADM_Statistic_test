...
printf OUT "outfile:mixscore_shuffle536.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters536";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle536.out\n", $nsamples, $nsnps;
