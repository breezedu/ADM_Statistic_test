...
printf OUT "outfile:mixscore_shuffle249.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters249";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle249.out\n", $nsamples, $nsnps;
