...
printf OUT "outfile:mixscore_shuffle685.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters685";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle685.out\n", $nsamples, $nsnps;
