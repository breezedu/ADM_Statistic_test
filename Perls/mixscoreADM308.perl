...
printf OUT "outfile:mixscore_shuffle308.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters308";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle308.out\n", $nsamples, $nsnps;
