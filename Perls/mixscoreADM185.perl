...
printf OUT "outfile:mixscore_shuffle185.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters185";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle185.out\n", $nsamples, $nsnps;
