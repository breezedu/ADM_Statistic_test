...
printf OUT "outfile:mixscore_shuffle112.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters112";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle112.out\n", $nsamples, $nsnps;
