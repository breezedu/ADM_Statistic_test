...
printf OUT "outfile:mixscore_shuffle974.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters974";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle974.out\n", $nsamples, $nsnps;
