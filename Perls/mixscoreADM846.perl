...
printf OUT "outfile:mixscore_shuffle846.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters846";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle846.out\n", $nsamples, $nsnps;
