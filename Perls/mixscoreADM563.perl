...
printf OUT "outfile:mixscore_shuffle563.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters563";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle563.out\n", $nsamples, $nsnps;
