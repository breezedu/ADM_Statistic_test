...
printf OUT "outfile:mixscore_shuffle140.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters140";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle140.out\n", $nsamples, $nsnps;
