...
printf OUT "outfile:mixscore_shuffle647.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters647";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle647.out\n", $nsamples, $nsnps;
