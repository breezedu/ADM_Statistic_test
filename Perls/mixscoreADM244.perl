...
printf OUT "outfile:mixscore_shuffle244.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters244";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle244.out\n", $nsamples, $nsnps;
