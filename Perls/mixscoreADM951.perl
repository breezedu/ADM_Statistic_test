...
printf OUT "outfile:mixscore_shuffle951.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters951";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle951.out\n", $nsamples, $nsnps;
