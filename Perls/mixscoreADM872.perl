...
printf OUT "outfile:mixscore_shuffle872.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters872";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle872.out\n", $nsamples, $nsnps;
