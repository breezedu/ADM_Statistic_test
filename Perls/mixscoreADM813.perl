...
printf OUT "outfile:mixscore_shuffle813.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters813";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle813.out\n", $nsamples, $nsnps;
