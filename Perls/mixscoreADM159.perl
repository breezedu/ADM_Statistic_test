...
printf OUT "outfile:mixscore_shuffle159.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters159";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle159.out\n", $nsamples, $nsnps;
