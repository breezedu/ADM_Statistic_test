...
printf OUT "outfile:mixscore_shuffle456.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters456";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle456.out\n", $nsamples, $nsnps;
