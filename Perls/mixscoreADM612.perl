...
printf OUT "outfile:mixscore_shuffle612.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters612";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle612.out\n", $nsamples, $nsnps;
