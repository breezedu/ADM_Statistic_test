...
printf OUT "outfile:mixscore_shuffle986.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters986";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle986.out\n", $nsamples, $nsnps;
