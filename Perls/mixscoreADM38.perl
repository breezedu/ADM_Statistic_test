...
printf OUT "outfile:mixscore_shuffle38.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters38";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle38.out\n", $nsamples, $nsnps;
