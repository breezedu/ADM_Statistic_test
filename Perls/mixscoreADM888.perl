...
printf OUT "outfile:mixscore_shuffle888.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters888";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle888.out\n", $nsamples, $nsnps;
