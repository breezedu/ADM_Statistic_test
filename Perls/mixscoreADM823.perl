...
printf OUT "outfile:mixscore_shuffle823.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters823";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle823.out\n", $nsamples, $nsnps;
