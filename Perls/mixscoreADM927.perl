...
printf OUT "outfile:mixscore_shuffle927.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters927";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle927.out\n", $nsamples, $nsnps;
