...
printf OUT "outfile:mixscore_shuffle226.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters226";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle226.out\n", $nsamples, $nsnps;
