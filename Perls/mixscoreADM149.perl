...
printf OUT "outfile:mixscore_shuffle149.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters149";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle149.out\n", $nsamples, $nsnps;
