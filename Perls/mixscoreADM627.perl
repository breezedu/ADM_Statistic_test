...
printf OUT "outfile:mixscore_shuffle627.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters627";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle627.out\n", $nsamples, $nsnps;
