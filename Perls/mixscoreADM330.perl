...
printf OUT "outfile:mixscore_shuffle330.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters330";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle330.out\n", $nsamples, $nsnps;
