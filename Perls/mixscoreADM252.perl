...
printf OUT "outfile:mixscore_shuffle252.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters252";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle252.out\n", $nsamples, $nsnps;
