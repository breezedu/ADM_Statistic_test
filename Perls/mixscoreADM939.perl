...
printf OUT "outfile:mixscore_shuffle939.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters939";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle939.out\n", $nsamples, $nsnps;
