...
printf OUT "outfile:mixscore_shuffle110.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters110";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle110.out\n", $nsamples, $nsnps;
