...
printf OUT "outfile:mixscore_shuffle322.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters322";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle322.out\n", $nsamples, $nsnps;
