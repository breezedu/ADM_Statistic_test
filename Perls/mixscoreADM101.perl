...
printf OUT "outfile:mixscore_shuffle101.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters101";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle101.out\n", $nsamples, $nsnps;
