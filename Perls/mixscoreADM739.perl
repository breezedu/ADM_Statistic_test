...
printf OUT "outfile:mixscore_shuffle739.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters739";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle739.out\n", $nsamples, $nsnps;
