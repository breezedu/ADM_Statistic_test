...
printf OUT "outfile:mixscore_shuffle793.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters793";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle793.out\n", $nsamples, $nsnps;
