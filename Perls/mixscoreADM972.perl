...
printf OUT "outfile:mixscore_shuffle972.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters972";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle972.out\n", $nsamples, $nsnps;
