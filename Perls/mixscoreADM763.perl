...
printf OUT "outfile:mixscore_shuffle763.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters763";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle763.out\n", $nsamples, $nsnps;
