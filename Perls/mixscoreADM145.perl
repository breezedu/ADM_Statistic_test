...
printf OUT "outfile:mixscore_shuffle145.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters145";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle145.out\n", $nsamples, $nsnps;
