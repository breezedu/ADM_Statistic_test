...
printf OUT "outfile:mixscore_shuffle738.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters738";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle738.out\n", $nsamples, $nsnps;
