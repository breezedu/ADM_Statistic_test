...
printf OUT "outfile:mixscore_shuffle706.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters706";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle706.out\n", $nsamples, $nsnps;
