...
printf OUT "outfile:mixscore_shuffle59.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters59";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle59.out\n", $nsamples, $nsnps;
