...
printf OUT "outfile:mixscore_shuffle746.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters746";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle746.out\n", $nsamples, $nsnps;
