...
printf OUT "outfile:mixscore_shuffle443.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters443";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle443.out\n", $nsamples, $nsnps;
