...
printf OUT "outfile:mixscore_shuffle405.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters405";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle405.out\n", $nsamples, $nsnps;
