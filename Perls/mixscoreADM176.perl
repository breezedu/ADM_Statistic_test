...
printf OUT "outfile:mixscore_shuffle176.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters176";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle176.out\n", $nsamples, $nsnps;
