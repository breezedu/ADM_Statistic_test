...
printf OUT "outfile:mixscore_shuffle55.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters55";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle55.out\n", $nsamples, $nsnps;
