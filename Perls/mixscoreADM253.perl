...
printf OUT "outfile:mixscore_shuffle253.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters253";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle253.out\n", $nsamples, $nsnps;
