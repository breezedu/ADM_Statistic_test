...
printf OUT "outfile:mixscore_shuffle370.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters370";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle370.out\n", $nsamples, $nsnps;
