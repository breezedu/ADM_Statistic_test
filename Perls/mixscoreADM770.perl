...
printf OUT "outfile:mixscore_shuffle770.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters770";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle770.out\n", $nsamples, $nsnps;
