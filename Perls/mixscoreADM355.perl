...
printf OUT "outfile:mixscore_shuffle355.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters355";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle355.out\n", $nsamples, $nsnps;
