...
printf OUT "outfile:mixscore_shuffle50.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters50";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle50.out\n", $nsamples, $nsnps;
