...
printf OUT "outfile:mixscore_shuffle333.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters333";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle333.out\n", $nsamples, $nsnps;
