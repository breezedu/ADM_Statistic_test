...
printf OUT "outfile:mixscore_shuffle212.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters212";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle212.out\n", $nsamples, $nsnps;
