...
printf OUT "outfile:mixscore_shuffle673.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters673";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle673.out\n", $nsamples, $nsnps;
