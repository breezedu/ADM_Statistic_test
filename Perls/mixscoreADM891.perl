...
printf OUT "outfile:mixscore_shuffle891.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters891";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle891.out\n", $nsamples, $nsnps;
