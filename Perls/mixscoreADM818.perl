...
printf OUT "outfile:mixscore_shuffle818.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters818";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle818.out\n", $nsamples, $nsnps;
