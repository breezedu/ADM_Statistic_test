...
printf OUT "outfile:mixscore_shuffle610.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters610";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle610.out\n", $nsamples, $nsnps;
