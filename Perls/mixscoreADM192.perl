...
printf OUT "outfile:mixscore_shuffle192.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters192";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle192.out\n", $nsamples, $nsnps;
