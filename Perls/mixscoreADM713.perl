...
printf OUT "outfile:mixscore_shuffle713.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters713";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle713.out\n", $nsamples, $nsnps;
