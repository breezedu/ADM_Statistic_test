...
printf OUT "outfile:mixscore_shuffle422.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters422";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle422.out\n", $nsamples, $nsnps;
