...
printf OUT "outfile:mixscore_shuffle718.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters718";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle718.out\n", $nsamples, $nsnps;
