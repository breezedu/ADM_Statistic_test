...
printf OUT "outfile:mixscore_shuffle734.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters734";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle734.out\n", $nsamples, $nsnps;
