...
printf OUT "outfile:mixscore_shuffle698.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters698";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle698.out\n", $nsamples, $nsnps;
