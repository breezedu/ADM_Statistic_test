...
printf OUT "outfile:mixscore_shuffle533.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters533";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle533.out\n", $nsamples, $nsnps;
