...
printf OUT "outfile:mixscore_shuffle481.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters481";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle481.out\n", $nsamples, $nsnps;
