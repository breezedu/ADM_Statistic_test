...
printf OUT "outfile:mixscore_shuffle970.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters970";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle970.out\n", $nsamples, $nsnps;
