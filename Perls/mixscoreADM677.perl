...
printf OUT "outfile:mixscore_shuffle677.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters677";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle677.out\n", $nsamples, $nsnps;
