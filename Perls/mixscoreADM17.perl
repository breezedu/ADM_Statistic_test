...
printf OUT "outfile:mixscore_shuffle17.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters17";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle17.out\n", $nsamples, $nsnps;
