...
printf OUT "outfile:mixscore_shuffle19.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters19";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle19.out\n", $nsamples, $nsnps;
