...
printf OUT "outfile:mixscore_shuffle762.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters762";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle762.out\n", $nsamples, $nsnps;
