...
printf OUT "outfile:mixscore_shuffle146.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters146";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle146.out\n", $nsamples, $nsnps;
