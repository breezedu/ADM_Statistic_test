...
printf OUT "outfile:mixscore_shuffle328.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters328";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle328.out\n", $nsamples, $nsnps;
