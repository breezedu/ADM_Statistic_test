...
printf OUT "outfile:mixscore_shuffle744.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters744";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle744.out\n", $nsamples, $nsnps;
