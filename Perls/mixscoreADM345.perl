...
printf OUT "outfile:mixscore_shuffle345.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters345";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle345.out\n", $nsamples, $nsnps;
