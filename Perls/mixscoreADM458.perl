...
printf OUT "outfile:mixscore_shuffle458.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters458";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle458.out\n", $nsamples, $nsnps;
