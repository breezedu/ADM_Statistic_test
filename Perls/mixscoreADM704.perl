...
printf OUT "outfile:mixscore_shuffle704.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters704";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle704.out\n", $nsamples, $nsnps;
