...
printf OUT "outfile:mixscore_shuffle408.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters408";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle408.out\n", $nsamples, $nsnps;
