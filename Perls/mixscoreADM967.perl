...
printf OUT "outfile:mixscore_shuffle967.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters967";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle967.out\n", $nsamples, $nsnps;
