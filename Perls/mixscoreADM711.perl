...
printf OUT "outfile:mixscore_shuffle711.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters711";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle711.out\n", $nsamples, $nsnps;
