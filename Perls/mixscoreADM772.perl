...
printf OUT "outfile:mixscore_shuffle772.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters772";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle772.out\n", $nsamples, $nsnps;
