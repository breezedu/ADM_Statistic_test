...
printf OUT "outfile:mixscore_shuffle534.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters534";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle534.out\n", $nsamples, $nsnps;
