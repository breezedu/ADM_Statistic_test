...
printf OUT "outfile:mixscore_shuffle196.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters196";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle196.out\n", $nsamples, $nsnps;
