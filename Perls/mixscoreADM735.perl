...
printf OUT "outfile:mixscore_shuffle735.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters735";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle735.out\n", $nsamples, $nsnps;
