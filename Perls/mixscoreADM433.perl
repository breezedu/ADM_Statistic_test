...
printf OUT "outfile:mixscore_shuffle433.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters433";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle433.out\n", $nsamples, $nsnps;
