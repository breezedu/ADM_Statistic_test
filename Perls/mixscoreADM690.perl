...
printf OUT "outfile:mixscore_shuffle690.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters690";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle690.out\n", $nsamples, $nsnps;
