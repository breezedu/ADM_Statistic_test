...
printf OUT "outfile:mixscore_shuffle414.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters414";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle414.out\n", $nsamples, $nsnps;
