...
printf OUT "outfile:mixscore_shuffle629.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters629";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle629.out\n", $nsamples, $nsnps;
