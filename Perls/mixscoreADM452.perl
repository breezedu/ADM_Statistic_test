...
printf OUT "outfile:mixscore_shuffle452.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters452";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle452.out\n", $nsamples, $nsnps;
