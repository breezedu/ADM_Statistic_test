...
printf OUT "outfile:mixscore_shuffle461.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters461";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle461.out\n", $nsamples, $nsnps;
