...
printf OUT "outfile:mixscore_shuffle122.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters122";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle122.out\n", $nsamples, $nsnps;
