...
printf OUT "outfile:mixscore_shuffle311.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters311";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle311.out\n", $nsamples, $nsnps;
