...
printf OUT "outfile:mixscore_shuffle659.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters659";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle659.out\n", $nsamples, $nsnps;
