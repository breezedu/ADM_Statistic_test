...
printf OUT "outfile:mixscore_shuffle641.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters641";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle641.out\n", $nsamples, $nsnps;
