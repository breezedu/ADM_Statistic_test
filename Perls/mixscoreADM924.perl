...
printf OUT "outfile:mixscore_shuffle924.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters924";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle924.out\n", $nsamples, $nsnps;
