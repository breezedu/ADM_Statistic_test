...
printf OUT "outfile:mixscore_shuffle969.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters969";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle969.out\n", $nsamples, $nsnps;
