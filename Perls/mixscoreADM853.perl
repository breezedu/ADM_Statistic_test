...
printf OUT "outfile:mixscore_shuffle853.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters853";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle853.out\n", $nsamples, $nsnps;
