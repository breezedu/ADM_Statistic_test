...
printf OUT "outfile:mixscore_shuffle760.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters760";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle760.out\n", $nsamples, $nsnps;
