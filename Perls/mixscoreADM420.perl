...
printf OUT "outfile:mixscore_shuffle420.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters420";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle420.out\n", $nsamples, $nsnps;
