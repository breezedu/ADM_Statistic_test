...
printf OUT "outfile:mixscore_shuffle128.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters128";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle128.out\n", $nsamples, $nsnps;
