...
printf OUT "outfile:mixscore_shuffle153.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters153";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle153.out\n", $nsamples, $nsnps;
