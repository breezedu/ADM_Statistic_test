...
printf OUT "outfile:mixscore_shuffle274.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters274";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle274.out\n", $nsamples, $nsnps;
