...
printf OUT "outfile:mixscore_shuffle51.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters51";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle51.out\n", $nsamples, $nsnps;
