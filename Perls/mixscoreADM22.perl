...
printf OUT "outfile:mixscore_shuffle22.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters22";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle22.out\n", $nsamples, $nsnps;
