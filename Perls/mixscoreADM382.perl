...
printf OUT "outfile:mixscore_shuffle382.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters382";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle382.out\n", $nsamples, $nsnps;
