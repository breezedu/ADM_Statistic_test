...
printf OUT "outfile:mixscore_shuffle544.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters544";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle544.out\n", $nsamples, $nsnps;
