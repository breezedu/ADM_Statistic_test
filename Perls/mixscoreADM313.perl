...
printf OUT "outfile:mixscore_shuffle313.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters313";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle313.out\n", $nsamples, $nsnps;
