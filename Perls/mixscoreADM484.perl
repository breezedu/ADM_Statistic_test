...
printf OUT "outfile:mixscore_shuffle484.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters484";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle484.out\n", $nsamples, $nsnps;
