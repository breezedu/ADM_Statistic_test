...
printf OUT "outfile:mixscore_shuffle979.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters979";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle979.out\n", $nsamples, $nsnps;
