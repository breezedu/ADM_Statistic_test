...
printf OUT "outfile:mixscore_shuffle326.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters326";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle326.out\n", $nsamples, $nsnps;
