...
printf OUT "outfile:mixscore_shuffle467.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters467";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle467.out\n", $nsamples, $nsnps;
