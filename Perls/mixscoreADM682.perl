...
printf OUT "outfile:mixscore_shuffle682.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters682";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle682.out\n", $nsamples, $nsnps;
