...
printf OUT "outfile:mixscore_shuffle242.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters242";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle242.out\n", $nsamples, $nsnps;
