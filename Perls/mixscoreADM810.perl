...
printf OUT "outfile:mixscore_shuffle810.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters810";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle810.out\n", $nsamples, $nsnps;
