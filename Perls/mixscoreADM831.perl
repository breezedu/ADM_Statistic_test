...
printf OUT "outfile:mixscore_shuffle831.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters831";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle831.out\n", $nsamples, $nsnps;
