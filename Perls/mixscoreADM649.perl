...
printf OUT "outfile:mixscore_shuffle649.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters649";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle649.out\n", $nsamples, $nsnps;
