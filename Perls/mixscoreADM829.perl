...
printf OUT "outfile:mixscore_shuffle829.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters829";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle829.out\n", $nsamples, $nsnps;
