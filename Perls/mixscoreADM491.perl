...
printf OUT "outfile:mixscore_shuffle491.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters491";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle491.out\n", $nsamples, $nsnps;
