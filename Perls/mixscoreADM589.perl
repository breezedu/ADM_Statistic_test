...
printf OUT "outfile:mixscore_shuffle589.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters589";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle589.out\n", $nsamples, $nsnps;
