...
printf OUT "outfile:mixscore_shuffle988.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters988";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle988.out\n", $nsamples, $nsnps;
