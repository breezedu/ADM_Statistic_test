...
printf OUT "outfile:mixscore_shuffle816.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters816";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle816.out\n", $nsamples, $nsnps;
