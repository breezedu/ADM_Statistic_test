...
printf OUT "outfile:mixscore_shuffle496.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters496";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle496.out\n", $nsamples, $nsnps;
