...
printf OUT "outfile:mixscore_shuffle727.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters727";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle727.out\n", $nsamples, $nsnps;
