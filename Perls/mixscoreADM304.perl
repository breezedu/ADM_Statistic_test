...
printf OUT "outfile:mixscore_shuffle304.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters304";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle304.out\n", $nsamples, $nsnps;
