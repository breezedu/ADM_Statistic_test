...
printf OUT "outfile:mixscore_shuffle243.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters243";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle243.out\n", $nsamples, $nsnps;
