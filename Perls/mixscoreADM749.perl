...
printf OUT "outfile:mixscore_shuffle749.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters749";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle749.out\n", $nsamples, $nsnps;
