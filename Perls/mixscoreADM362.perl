...
printf OUT "outfile:mixscore_shuffle362.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters362";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle362.out\n", $nsamples, $nsnps;
