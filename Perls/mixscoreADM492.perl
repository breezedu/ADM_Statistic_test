...
printf OUT "outfile:mixscore_shuffle492.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters492";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle492.out\n", $nsamples, $nsnps;
