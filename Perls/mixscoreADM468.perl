...
printf OUT "outfile:mixscore_shuffle468.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters468";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle468.out\n", $nsamples, $nsnps;
