...
printf OUT "outfile:mixscore_shuffle601.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters601";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle601.out\n", $nsamples, $nsnps;
