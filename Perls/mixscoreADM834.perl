...
printf OUT "outfile:mixscore_shuffle834.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters834";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle834.out\n", $nsamples, $nsnps;
