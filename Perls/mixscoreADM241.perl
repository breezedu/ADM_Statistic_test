...
printf OUT "outfile:mixscore_shuffle241.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters241";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle241.out\n", $nsamples, $nsnps;
