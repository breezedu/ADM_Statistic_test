...
printf OUT "outfile:mixscore_shuffle625.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters625";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle625.out\n", $nsamples, $nsnps;
