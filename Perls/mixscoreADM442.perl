...
printf OUT "outfile:mixscore_shuffle442.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters442";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle442.out\n", $nsamples, $nsnps;
