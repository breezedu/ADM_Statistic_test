...
printf OUT "outfile:mixscore_shuffle211.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters211";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle211.out\n", $nsamples, $nsnps;
