...
printf OUT "outfile:mixscore_shuffle68.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters68";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle68.out\n", $nsamples, $nsnps;
