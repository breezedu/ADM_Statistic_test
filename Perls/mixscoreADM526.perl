...
printf OUT "outfile:mixscore_shuffle526.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters526";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle526.out\n", $nsamples, $nsnps;
