...
printf OUT "outfile:mixscore_shuffle378.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters378";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle378.out\n", $nsamples, $nsnps;
