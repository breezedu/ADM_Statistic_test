...
printf OUT "outfile:mixscore_shuffle275.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters275";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle275.out\n", $nsamples, $nsnps;
