...
printf OUT "outfile:mixscore_shuffle835.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters835";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle835.out\n", $nsamples, $nsnps;
