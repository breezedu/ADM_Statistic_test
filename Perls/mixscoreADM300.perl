...
printf OUT "outfile:mixscore_shuffle300.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters300";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle300.out\n", $nsamples, $nsnps;
