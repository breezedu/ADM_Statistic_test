...
printf OUT "outfile:mixscore_shuffle689.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters689";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle689.out\n", $nsamples, $nsnps;
