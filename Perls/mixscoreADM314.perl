...
printf OUT "outfile:mixscore_shuffle314.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters314";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle314.out\n", $nsamples, $nsnps;
