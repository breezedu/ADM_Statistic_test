...
printf OUT "outfile:mixscore_shuffle646.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters646";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle646.out\n", $nsamples, $nsnps;
