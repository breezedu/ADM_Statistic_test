...
printf OUT "outfile:mixscore_shuffle717.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters717";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle717.out\n", $nsamples, $nsnps;
