...
printf OUT "outfile:mixscore_shuffle656.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters656";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle656.out\n", $nsamples, $nsnps;
