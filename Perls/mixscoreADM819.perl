...
printf OUT "outfile:mixscore_shuffle819.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters819";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle819.out\n", $nsamples, $nsnps;
