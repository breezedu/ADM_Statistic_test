...
printf OUT "outfile:mixscore_shuffle780.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters780";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle780.out\n", $nsamples, $nsnps;
