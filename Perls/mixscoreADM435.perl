...
printf OUT "outfile:mixscore_shuffle435.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters435";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle435.out\n", $nsamples, $nsnps;
