...
printf OUT "outfile:mixscore_shuffle887.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters887";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle887.out\n", $nsamples, $nsnps;
