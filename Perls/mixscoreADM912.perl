...
printf OUT "outfile:mixscore_shuffle912.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters912";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle912.out\n", $nsamples, $nsnps;
