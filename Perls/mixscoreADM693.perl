...
printf OUT "outfile:mixscore_shuffle693.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters693";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle693.out\n", $nsamples, $nsnps;
