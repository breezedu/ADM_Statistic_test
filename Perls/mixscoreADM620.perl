...
printf OUT "outfile:mixscore_shuffle620.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters620";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle620.out\n", $nsamples, $nsnps;
