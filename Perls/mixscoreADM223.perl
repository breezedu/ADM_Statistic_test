...
printf OUT "outfile:mixscore_shuffle223.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters223";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle223.out\n", $nsamples, $nsnps;
