...
printf OUT "outfile:mixscore_shuffle611.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters611";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle611.out\n", $nsamples, $nsnps;
