...
printf OUT "outfile:mixscore_shuffle71.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters71";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle71.out\n", $nsamples, $nsnps;
