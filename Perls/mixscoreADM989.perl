...
printf OUT "outfile:mixscore_shuffle989.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters989";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle989.out\n", $nsamples, $nsnps;
