...
printf OUT "outfile:mixscore_shuffle595.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters595";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle595.out\n", $nsamples, $nsnps;
