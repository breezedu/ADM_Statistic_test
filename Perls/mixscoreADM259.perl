...
printf OUT "outfile:mixscore_shuffle259.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters259";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle259.out\n", $nsamples, $nsnps;
