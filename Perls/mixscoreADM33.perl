...
printf OUT "outfile:mixscore_shuffle33.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters33";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle33.out\n", $nsamples, $nsnps;
