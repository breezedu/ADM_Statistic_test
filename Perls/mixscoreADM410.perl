...
printf OUT "outfile:mixscore_shuffle410.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters410";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle410.out\n", $nsamples, $nsnps;
