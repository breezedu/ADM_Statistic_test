...
printf OUT "outfile:mixscore_shuffle283.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters283";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle283.out\n", $nsamples, $nsnps;
