...
printf OUT "outfile:mixscore_shuffle708.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters708";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle708.out\n", $nsamples, $nsnps;
