...
printf OUT "outfile:mixscore_shuffle884.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters884";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle884.out\n", $nsamples, $nsnps;
