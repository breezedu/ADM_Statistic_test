...
printf OUT "outfile:mixscore_shuffle411.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters411";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle411.out\n", $nsamples, $nsnps;
