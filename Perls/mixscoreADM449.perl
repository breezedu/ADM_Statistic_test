...
printf OUT "outfile:mixscore_shuffle449.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters449";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle449.out\n", $nsamples, $nsnps;
