...
printf OUT "outfile:mixscore_shuffle608.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters608";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle608.out\n", $nsamples, $nsnps;
