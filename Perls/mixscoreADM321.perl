...
printf OUT "outfile:mixscore_shuffle321.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters321";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle321.out\n", $nsamples, $nsnps;
