...
printf OUT "outfile:mixscore_shuffle820.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters820";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle820.out\n", $nsamples, $nsnps;
