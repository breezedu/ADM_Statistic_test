...
printf OUT "outfile:mixscore_shuffle971.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters971";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle971.out\n", $nsamples, $nsnps;
