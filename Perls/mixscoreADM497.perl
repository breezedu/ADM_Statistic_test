...
printf OUT "outfile:mixscore_shuffle497.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters497";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle497.out\n", $nsamples, $nsnps;
