...
printf OUT "outfile:mixscore_shuffle53.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters53";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle53.out\n", $nsamples, $nsnps;
