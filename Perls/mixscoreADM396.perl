...
printf OUT "outfile:mixscore_shuffle396.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters396";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle396.out\n", $nsamples, $nsnps;
