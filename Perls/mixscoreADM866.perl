...
printf OUT "outfile:mixscore_shuffle866.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters866";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle866.out\n", $nsamples, $nsnps;
