...
printf OUT "outfile:mixscore_shuffle387.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters387";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle387.out\n", $nsamples, $nsnps;
