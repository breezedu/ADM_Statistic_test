...
printf OUT "outfile:mixscore_shuffle968.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters968";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle968.out\n", $nsamples, $nsnps;
