...
printf OUT "outfile:mixscore_shuffle529.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters529";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle529.out\n", $nsamples, $nsnps;
