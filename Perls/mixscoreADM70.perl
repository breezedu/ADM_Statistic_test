...
printf OUT "outfile:mixscore_shuffle70.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters70";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle70.out\n", $nsamples, $nsnps;
