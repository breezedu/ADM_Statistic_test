...
printf OUT "outfile:mixscore_shuffle39.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters39";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle39.out\n", $nsamples, $nsnps;
