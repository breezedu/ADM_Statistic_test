...
printf OUT "outfile:mixscore_shuffle630.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters630";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle630.out\n", $nsamples, $nsnps;
