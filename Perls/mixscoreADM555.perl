...
printf OUT "outfile:mixscore_shuffle555.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters555";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle555.out\n", $nsamples, $nsnps;
