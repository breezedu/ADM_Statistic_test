...
printf OUT "outfile:mixscore_shuffle643.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters643";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle643.out\n", $nsamples, $nsnps;
