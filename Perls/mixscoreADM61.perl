...
printf OUT "outfile:mixscore_shuffle61.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters61";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle61.out\n", $nsamples, $nsnps;
