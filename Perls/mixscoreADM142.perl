...
printf OUT "outfile:mixscore_shuffle142.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters142";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle142.out\n", $nsamples, $nsnps;
