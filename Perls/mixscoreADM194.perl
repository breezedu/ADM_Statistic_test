...
printf OUT "outfile:mixscore_shuffle194.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters194";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle194.out\n", $nsamples, $nsnps;
