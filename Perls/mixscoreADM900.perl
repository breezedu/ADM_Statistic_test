...
printf OUT "outfile:mixscore_shuffle900.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters900";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle900.out\n", $nsamples, $nsnps;
