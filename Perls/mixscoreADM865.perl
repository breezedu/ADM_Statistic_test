...
printf OUT "outfile:mixscore_shuffle865.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters865";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle865.out\n", $nsamples, $nsnps;
