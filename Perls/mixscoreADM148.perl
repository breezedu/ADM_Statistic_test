...
printf OUT "outfile:mixscore_shuffle148.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters148";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle148.out\n", $nsamples, $nsnps;
