...
printf OUT "outfile:mixscore_shuffle317.out\n";
close(OUT);
my $cmd = "./bin/mixscore ADM parameters317";
system($cmd);
printf "Output of MIX score (%d samples, %d SNPs) is in mixscore_shuffle317.out\n", $nsamples, $nsnps;
